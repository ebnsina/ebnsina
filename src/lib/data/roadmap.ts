...
export const ROADMAP: RoadmapLevel[] = [
	...
	},
	{
		...
		outcomes: [
			...
			'Real-time, event-driven interfaces'
		],
	...
	},
	{
		...
		level: 'advanced',
		blurb:
			'Run it in production: infrastructure, data at scale, and growing horizontally without falling over.',
		outcomes: [
	...
	},
	{
		...
		outcomes: [
			...
			'Staying resilient when things break'
		],
