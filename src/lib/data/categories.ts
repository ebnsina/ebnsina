...
export const CATEGORIES: Record<string, CategoryMeta> = {
	...
	sql: { label: 'SQL', description: 'Querying, joins, indexes, transactions, and query optimization', group: 'Foundations' },
	'operating-systems': { label: 'Operating Systems', description: 'Processes, threads, memory, scheduling, and system calls', group: 'Foundations' },
	...
	nosql: { label: 'NoSQL', description: 'Key-value, document, wide-column, and graph data models', group: 'Data' },
	...
	redis: { label: 'Redis', description: 'Data structures, persistence, pub/sub, streams, and clustering', group: 'Data' },
	...
	'distributed-systems': { label: 'Distributed Systems', description: 'CAP, consistency, consensus, ordering, and distributed transactions', group: 'Scaling' },
