...
রহিমের একটা ছোট কুরিয়ার কোম্পানি। সকালে ম্যানেজার ফাতেমা তার হাতে একটা লিস্ট ধরিয়ে দেয় — আজ মিরপুর, ধানমন্ডি, উত্তরা আর গুলশানে দশটা প্যাকেট পৌঁছাতে হবে। এই একই লিস্ট, কিন্তু পৌঁছানোর রাস্তা তো অনেকগুলো। রহিম চাইলে আগে উত্তরা গিয়ে ঘুরে আসতে পারে, আবার চাইলে ধানমন্ডি দিয়ে শুরু করতে পারে। প্রতিটা রুটের জন্য সময় আর তেল খরচ আলাদা।

রহিম হুট করে সামনের রাস্তা ধরে না। মনে মনে সে কয়েকটা রুট হিসাব করে — এই সময়ে মিরপুর রোডে জ্যাম থাকে, কিন্তু ভোরের দিকে বিমানবন্দর সড়ক ফাঁকা। এই যে "কোন রাস্তায় এখন জ্যাম, কোনটা ফাঁকা" — এই জানাশোনাটাই তার আসল হাতিয়ার। কয়েকটা সম্ভাব্য রুটের আন্দাজি সময় আর তেল খরচ তুলনা করে সে সবচেয়ে কম খরচেরটা বেছে নেয়, তারপর বের হয়।

এই গল্পটাই আসলে **query planner** (বা optimizer)। ফাতেমার দেওয়া প্যাকেটের লিস্ট হলো আপনার একটা SQL query — একই কাজ, কিন্তু সেটা চালানোর অনেকগুলো **execution plan** আছে (কোন index ধরে যাবে নাকি পুরো টেবিল **scan** করবে, কোন টেবিল আগে **join** করবে)। রহিমের জ্যামের জানাশোনা হলো database-এর **table statistics**, আর রুটের আন্দাজি খরচ তুলনা করাটাই **cost estimation**। planner প্রতিটা সম্ভাব্য plan-এর cost আন্দাজ করে সবচেয়ে সস্তাটা বেছে নেয় — ঠিক যেমন রহিম কম খরচের রুট বাছে। বাস্তবে PostgreSQL বা MySQL-এ `EXPLAIN` চালালে আপনি এই বাছাই করা রুটটাই — মানে planner শেষমেশ কোন plan-টা বেছে নিয়েছে — চোখের সামনে দেখতে পান।
