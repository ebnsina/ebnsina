...
রহিমের হাতে ৯০০ পৃষ্ঠার একটা মোটা রেফারেন্স বই। শিক্ষক বললেন, বইয়ে "photosynthesis" শব্দটা যতবার এসেছে সবগুলো পেজ খুঁজে বের করো। রহিম চাইলে পৃষ্ঠা এক থেকে শুরু করে নয়শো পর্যন্ত এক এক করে পড়তে পারে — কিন্তু সেটা সারা বিকেল খেয়ে ফেলবে। তার বদলে সে বইয়ের একদম পেছনে গেল, যেখানে অক্ষরের ক্রমে সাজানো index আছে। "photosynthesis" খুঁজতেই পাশে লেখা — পৃষ্ঠা ৪৫, ২১১, ৬৭৮। রহিম সোজা ওই তিনটা পেজে চলে গেল, সেকেন্ডের মধ্যে কাজ শেষ।

পরের দিন শিক্ষক বললেন, এবার "the" শব্দটা কোন কোন পেজে আছে বের করো। রহিম আবার পেছনের index-এ হাত দিতে গিয়ে থমকে গেল — "the" তো প্রায় প্রতিটা পেজেই আছে, index-এ লিখলে নয়শো পৃষ্ঠার নম্বরই লিখতে হবে। এখানে index দেখে এক এক পেজে লাফানোর চেয়ে বইটা সোজা গোড়া থেকে পড়ে যাওয়াই আসলে দ্রুত। রহিম বুদ্ধি খাটিয়ে ঠিক করল — বিরল শব্দের জন্য index, আর সর্বত্র থাকা শব্দের জন্য পুরো বই পড়া।

এটাই database-এর গল্প। পুরো বই এক এক পেজে পড়া হলো **full-table scan**, আর পেছনের অক্ষরক্রমিক index দেখে সোজা পেজে লাফানো হলো **index lookup**। কোনটা বেছে নেবে সেটা ঠিক করে **query planner** — বিরল মান (high selectivity) হলে index, আর প্রায়-সব-row-এ থাকা মান (low selectivity) হলে scan। রহিম মনে মনে যে হিসাব করল, `EXPLAIN` চালালে ঠিক সেই সিদ্ধান্তটাই তোমাকে দেখিয়ে দেয় — planner index ধরল নাকি scan করল। বাস্তবে Postgres-এ `status = 'active'` যেখানে ৯০% row-ই active, সেখানে planner index থাকা সত্ত্বেও scan বেছে নেয় — ঠিক "the" শব্দের মতোই।
