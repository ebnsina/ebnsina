...
ধরুন আপনি একটা স্কুলের অফিসে বসে আছেন। কেরানি করিম সাহেবের টেবিলে দুটো আলাদা রেজিস্টার খাতা। একটা "ছাত্র রেজিস্টার" — প্রতি পাতায় এক লাইনে একজন ছাত্রের তথ্য: রোল নম্বর, নাম, বয়স, কোন ক্লাসে পড়ে তার ক্লাস-আইডি। প্রতিটা লাইনের বাঁয়ে বসানো রোল নম্বরটাই ওই ছাত্রকে আলাদা করে চেনায় — রহিম আর ফাতেমার নাম এক হলেও রোল আলাদা, তাই কখনো গুলিয়ে যায় না। আরেকটা খাতা "ক্লাস রেজিস্টার" — এক লাইনে এক ক্লাস: ক্লাস-আইডি, ক্লাসের নাম, ঘরের নম্বর।

এখন হেডস্যার এসে বললেন, "ক্লাস নাইনের সব ছাত্রের একটা লিস্ট দাও।" করিম সাহেব ছাত্র রেজিস্টারটা খুলে উপর থেকে নিচে চোখ বোলান, আর শুধু যাদের ক্লাস-আইডি নাইনের সাথে মেলে তাদের লাইনগুলোই আলাদা কাগজে টুকে নেন — বাকিদের বাদ। কারো ক্লাসের ঘর কোথায় জানতে হলে ছাত্রের ক্লাস-আইডি দিয়ে ক্লাস রেজিস্টারে গিয়ে মিলিয়ে দেখেন। দুই খাতা এই আইডি দিয়েই একে অপরের সাথে বাঁধা।

গল্পের প্রতিটা রেজিস্টার খাতা আসলে একটা **table**, খাতার এক-একটা লাইন হলো একটা **row**, আর রোল/নাম/বয়সের মতো ঘরগুলো হলো **column**। রোল নম্বরটা প্রতিটা row-কে unique করে চেনায় — এটাই **key**। দুই খাতাকে ক্লাস-আইডি দিয়ে জোড়া লাগানোটাই দুই table-এর মধ্যে **relation**। আর "শুধু ক্লাস নাইনের লাইনগুলো টুকে নাও" — এটাই `SELECT ... WHERE`: পুরো table থেকে শর্তে মেলা row-গুলো বেছে নেওয়া। বাস্তবে একটা database ঠিক এভাবেই কাজ করে, শুধু করিম সাহেবের হাতে চোখ বোলানোর বদলে কাজটা মিলিসেকেন্ডে সেরে ফেলে — স্কুলের হাজার হাজার ছাত্রের হাজিরা বা রেজাল্ট সিস্টেম এই একই ধারণার উপর দাঁড়িয়ে।
