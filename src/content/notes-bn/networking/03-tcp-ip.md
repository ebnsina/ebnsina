...
করিমকে একটা জরুরি দলিল — ধরুন ৫০ পাতার — ডাকযোগে ফাতেমার কাছে পাঠাতে হবে, একটা পাতাও হারানো চলবে না, আর ফাতেমাকে ঠিক ১ থেকে ৫০ ক্রমেই পড়তে হবে। করিম প্রতিটা পাতায় নম্বর বসায় আর প্রত্যেকটা আলাদা রেজিস্টার্ড চিঠি হিসেবে পাঠায়, যেগুলোর প্রতিটার জন্য ফাতেমাকে সই করা একটা "পেয়েছি" রসিদ ফেরত পাঠাতে হয়। শুরু করার আগে করিম একটা ছোট চিঠি দেয় "তুমি কি নেওয়ার জন্য রেডি?", ফাতেমা জবাব দেয় "রেডি, তুমিও কনফার্ম করো", করিম শেষ কনফার্মেশন পাঠায় — তারপরই আসল পাতাগুলো যাওয়া শুরু হয়।

করিম প্রতিটা পাঠানো পাতার একটা কপি নিজের কাছে রেখে দেয়। কোনো একটা পাতার সই করা রসিদ যদি নির্দিষ্ট সময়ের মধ্যে ফেরত না আসে, করিম ধরে নেয় ওটা পথে হারিয়েছে আর কপি থেকে ওই একই নম্বরের পাতা আবার পাঠায়। ওদিকে ডাক ব্যবস্থার এলোমেলো পথের কারণে পাতাগুলো ফাতেমার কাছে উল্টাপাল্টা ক্রমে পৌঁছাতে পারে — ৩ নম্বর হয়তো ৫ নম্বরের পরে আসে। ফাতেমা তাড়াহুড়ো করে না; নম্বর দেখে পাতাগুলো সাজিয়ে রাখে আর ঠিক ক্রম অনুযায়ীই দলিলটা জোড়া দেয়।
