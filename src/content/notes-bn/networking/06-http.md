...
রহিমের একটা পার্সেল ডেলিভারি সার্ভিস। শুরুতে নিয়মটা ছিল সহজ — একজন ডেলিভারি বয়, করিম, একটাই সরু গলি দিয়ে একবারে একটা করে পার্সেল হাতে নিয়ে যায়। প্রথম পার্সেলটা পৌঁছে দিয়ে ফিরে না আসা পর্যন্ত পরের পার্সেল ধরাই হয় না। একদিন একটা পার্সেলের ঠিকানা খুঁজে পেতে করিমের আধা ঘণ্টা লেগে গেল, আর পেছনে পাঁচটা তৈরি পার্সেল শুধু অপেক্ষা করতে থাকল — যদিও সেগুলো এক মিনিটেই পৌঁছে দেওয়া যেত।

রহিম বুঝল, এভাবে চলবে না। প্রথমে সে ব্যবস্থা বদলাল — করিম এখন একই ট্রিপে অনেকগুলো পার্সেল সাজিয়ে একসাথে নিয়ে যায়, একটার জন্য আরেকটা আটকে থাকে না। কিন্তু সমস্যা হলো, ওই একটাই সরু গলি — গলির মুখে একটা রিকশা উল্টে পড়লে পুরো ট্রিপটাই আটকে যায়, সব পার্সেল একসাথে থেমে থাকে। শেষমেশ রহিম করিমকে একটা চটপটে মোটরসাইকেল কিনে দিল, যেটা এক রাস্তা বন্ধ দেখলেই সঙ্গে সঙ্গে অন্য গলি দিয়ে ঘুরে যায় — একটা পার্সেল আটকালেও বাকিগুলো চলতেই থাকে।
