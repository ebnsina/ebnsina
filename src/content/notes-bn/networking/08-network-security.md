...
করিম থাকে একটা গেটেড আবাসিক এলাকায়। পুরো এলাকা ঘিরে উঁচু একটা বাউন্ডারি ওয়াল, ভেতরে ঢোকা-বেরোনোর একটাই গেট। সেই গেটে একজন দারোয়ান বসে থাকে — কে ঢুকতে পারবে, কে বেরোতে পারবে, কোন গাড়ি ভেতরে যাবে, সব সে নিয়ম মিলিয়ে যাচাই করে। বাইরের অচেনা কেউ এলে লিস্টে নাম না থাকলে তাকে ফিরিয়ে দেয়। আবার এলাকার ভেতরটাও পুরো খোলা নয় — আলাদা আলাদা ব্লক, প্রতিটার নিজের তালা দেওয়া গেট, একটা ব্লকের চাবি দিয়ে পাশের ব্লকে ঢোকা যায় না।

রহিমকে একদিন শহরের একটা বিপজ্জনক এলাকা পার হয়ে অফিসে যেতে হয়। কমিউনিটি তাকে একটা ঢাকা, সিল করা প্রাইভেট ভ্যানে তুলে দেয় — বাইরের কেউ দেখতেও পায় না ভেতরে কে বসে আছে, ছিনতাইকারীও বুঝতে পারে না গাড়িতে কী যাচ্ছে। এদিকে পুরো এলাকা জুড়ে CCTV আর ফাতেমা নামের এক সতর্ক নাইট-গার্ড আছে — কেউ সন্দেহজনকভাবে দেয়াল টপকাতে গেলে বা অচেনা কেউ ঘোরাঘুরি করলে সে সাথে সাথে টের পায় আর তাকে থামায়।

এই গল্পটাই আসলে **network security**। গেটে দারোয়ানের নিয়ম মিলিয়ে ঢোকা-বেরোনো যাচাই করাটা হলো **firewall** — সীমানায় বসে ট্রাফিক filter করা। রহিমের ঢাকা সিল করা ভ্যানটা হলো **VPN encrypted tunnel** — বিপজ্জনক নেটওয়ার্ক পেরিয়েও ভেতরের ডেটা কেউ দেখতে পায় না। CCTV আর ফাতেমার সতর্ক নজর হলো **IDS/IPS** — সন্দেহজনক নড়াচড়া detect করা (IDS) আর সেটা থামিয়ে দেওয়া (IPS)। আর আলাদা তালা দেওয়া ব্লকগুলো হলো **network segmentation** — এক ব্লকে সিঁধ কাটলেও পুরো এলাকা খুলে যায় না। বাস্তবে ঠিক এভাবেই একটা কোম্পানি firewall, VPN, IDS/IPS আর segmentation একসাথে সাজিয়ে defense-in-depth বানায় — কোনো একটা লেয়ার ফাঁকি দিলেও বাকিগুলো ধরে ফেলে।
