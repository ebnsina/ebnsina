...
বড় একটা অফিসের মেইলরুম কল্পনা করুন। দেয়ালজুড়ে সারি সারি ছোট ছোট খোপ (pigeonhole) — প্রতিটা খোপের গায়ে লেখা প্রাপকের নামের প্রথম অক্ষর: ক, খ, গ, ম, র... করিম নামের একটা চিঠি এলে মেইলরুমের ছেলেটা পুরো ভবনের সবার নাম মেলায় না; সে শুধু নামের প্রথম অক্ষরটা দেখে — "ক" — আর সোজা "ক" খোপে চিঠিটা রেখে দেয়। পরে মালেকের চিঠি খুঁজতে হলেও একই নিয়ম: "ম" খোপে হাত ঢুকিয়ে টেনে নাও। হাজারটা খোপ ঘাঁটতে হয় না, এক ঝটকায় পাওয়া যায়।

তবে একটা ঝামেলা আছে। করিম আর কামাল — দুজনের নামই "ক" দিয়ে শুরু, তাই দুটো চিঠিই একই "ক" খোপে গিয়ে পড়ে। মেইলরুমের ছেলে তখন গোটা ভবন খোঁজে না, শুধু "ক" খোপের ছোট্ট গোছাটা একটু উল্টেপাল্টে দেখে করিমেরটা বের করে ফেলে। খোপগুলো যত ভালোভাবে ভাগ করা থাকে, প্রতিটা খোপে তত কম চিঠি জমে, খোঁজাও তত দ্রুত।

এই গল্পটাই আসলে **hash map**। নামের প্রথম অক্ষর বের করার নিয়মটা হলো **hash function** — একটা key নিয়ে সেটাকে একটা নির্দিষ্ট খোপে (bucket) পাঠিয়ে দেয়। খোপ থেকে সরাসরি চিঠি তুলে নেওয়াটাই **O(1) lookup** — পুরো লিস্ট স্ক্যান না করে এক লাফে জিনিসটা পাওয়া। আর করিম-কামাল একই খোপে পড়ে যাওয়াটাই **collision**, যেটা সামলাতে ওই ছোট গোছাটুকুই কেবল খোঁজা হয়। বাস্তবে ডেটাবেসের index থেকে শুরু করে প্রোগ্রামের `Map`/`Set`, কিংবা ভাষার dictionary — সবই ঠিক এভাবে key থেকে সরাসরি value বের করে আনে।
