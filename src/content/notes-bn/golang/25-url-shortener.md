...
শহরের নামকরা এক রেস্টুরেন্টের সামনে করিমের ভ্যালে পার্কিং ডেস্ক। আপনি বিশাল একটা গাড়ি নিয়ে এসে ফটকের সামনে থামলেন, নেমে গেলেন — গাড়ি কোথায় রাখবেন সেই ঝামেলা আর আপনার নয়। করিম আপনাকে ধরিয়ে দিল একটা ছোট্ট নম্বর দেওয়া টিকিট, আর নিজের খাতায় টুকে রাখল: টিকিট ৪২ মানে গাড়িটা বি-ব্লকের ১৭ নম্বর স্লটে। এই ছোট টিকিটটাই এখন আপনার পুরো গাড়ির পরিচয় — পকেটে অনায়াসে এঁটে যায়।

খাওয়া শেষে ফিরে এসে আপনি শুধু টিকিটটা বাড়িয়ে দিলেন। করিম খাতা দেখে চট করে বুঝে গেল কোন স্লট, আর আপনার সেই একই গাড়ি এনে সামনে হাজির করল। দুটো গাড়ির টিকিট নম্বর কখনো এক হয় না — নাহলে করিম কার গাড়ি কাকে দেবে গুলিয়ে ফেলবে। আর রহিম সাহেবের মতো নিয়মিত VIP অতিথিদের গাড়ি করিম খাতা না ঘেঁটেই সামনের সারিতে হাতের নাগালে রাখে, যেন চাইলেই সেকেন্ডে বের করে দেওয়া যায়।

এই গল্পটাই আসলে একটা **URL shortener**। বড় গাড়ি হলো লম্বা মূল URL, ছোট টিকিট হলো **short code**, আর করিমের খাতা হলো code-থেকে-URL-এর **key-value mapping**। টিকিট দেখানো মানেই **lookup** করে সেই মূল গাড়িতে **redirect** করে দেওয়া। প্রতিটা টিকিট নম্বর যেমন **unique**, তেমনি প্রতিটা short code-ও unique হতে হয়। আর VIP গাড়ি সামনে রাখাটাই হট লিংক **cache** করে রাখা। বাস্তবে bit.ly ঠিক এভাবেই কাজ করে — লম্বা একটা লিংককে ছোট্ট কোডে বেঁধে দেয়, আর কেউ সেই ছোট লিংকে ক্লিক করলেই আসল ঠিকানায় পাঠিয়ে দেয়।
