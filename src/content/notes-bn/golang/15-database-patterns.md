...
রহিমের একটা বড় মুদির দোকান — সামনে বিক্রির কাউন্টার, আর পেছনে বিশাল গুদাম। নিয়ম একটাই কড়া: কোনো সেলসম্যান নিজে গুদামে ঢুকে জিনিস হাতড়াতে পারবে না। গুদামের ভেতরের সাজানো-গোছানো, কোন তাকে কী আছে, কোনটা কীভাবে বের করতে হয় — এসব শুধু ফাতেমা জানে, দোকানের একমাত্র গুদাম-রক্ষক। সেলসম্যানকে কিছু লাগলে সে শুধু কাউন্টারে দাঁড়িয়ে ফাতেমাকে বলে "পাঁচ কেজি চাল দাও", ব্যস। চাল কোন বস্তায়, কোন তাকে, সেটা তার জানার দরকার নেই — একটা পরিষ্কার কাউন্টারের পেছনেই পুরো গুদামের ঝামেলা লুকানো।

আরেকটা মজার ব্যবস্থা আছে রহিমের। প্রতিটা অর্ডার ডেলিভারি দিতে সে প্রতিবার নতুন ডেলিভারি বয় ভাড়া করে না — সেটা তো সময় আর টাকা দুটোই নষ্ট। বরং তিন-চারজন ডেলিভারি বয় সবসময় দোকানেই বসা থাকে; একজন ডেলিভারি সেরে ফিরলেই তাকে পরের অর্ডারে পাঠানো হয়। ভিড় বেশি হলে সবাই ব্যস্ত, তখন নতুন অর্ডার একটু অপেক্ষা করে খালি হওয়া বয়ের জন্য। আর কেউ যদি ঘণ্টার পর ঘণ্টা বসেই থাকে, রহিম তাকে ছুটি দিয়ে দেয় — বসিয়ে খাওয়ানোর মানে হয় না।

এটাই আসলে এই চ্যাপ্টারের **repository pattern** আর **connection pool**। ফাতেমা হলো repository — সব ডেটা অ্যাক্সেস একটাই পরিষ্কার কাউন্টার (interface) দিয়ে যায়, ভেতরের SQL বা গুদামের বিন্যাস বাইরের service layer কখনো দেখে না। আর ডেলিভারি বয়দের দলটা হলো connection pool — কয়েকটা database connection বারবার শেয়ার করে reuse হয়, প্রতিবার নতুন connection খোলার খরচ বাঁচে; সবাই ব্যস্ত থাকলে নতুন query অপেক্ষা করে (`MaxOpenConns`), আর বেশিক্ষণ বসে থাকা idle connection বন্ধ হয়ে যায় (`ConnMaxIdleTime`)। বাস্তবে Go-র `database/sql` ঠিক এভাবেই pool চালায়, আর একটা ডেলিভারি বয়কে কয়েকটা কাজ একসাথে করতে বলা — আগে ইনভেন্টরি কমাও, তারপর অর্ডার লেখো, দুটোর একটা ভুল হলে পুরোটা বাতিল — সেটাই **transaction**, হয় সব হবে নয় কিছুই না।
