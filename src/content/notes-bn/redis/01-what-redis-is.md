...
রহিম মিয়ার মুদি দোকানে কোনো দাম-স্টকের খাতা কাউন্টারে নেই। আপনি জিজ্ঞেস করলেন, "চিনি কত?" — সাথে সাথে জবাব, "আটান্ন টাকা কেজি, বস্তা আছে তিনটা।" ডাল, তেল, আটা — যা-ই নাম ধরে জিজ্ঞেস করেন, রহিম মিয়া চোখ বন্ধ করে মুখস্থ বলে দেন, কারণ সব দাম আর স্টকের হিসাব তার মাথায় গাঁথা। পাশের দোকানের করিম প্রতিবার পেছনের স্টোর রুমে হেঁটে গিয়ে ফাইল ঘেঁটে দাম বের করে — রহিম মিয়ার কাছে সেই হাঁটাহাঁটির বালাই নেই, উত্তর আসে নিমেষে।

তবে এই মুখস্থ রাখার একটা ঝুঁকি আছে। একদিন প্রচণ্ড জ্বরে রহিম মিয়া দুদিন অজ্ঞান হয়ে রইলেন — উঠে দেখলেন মাথার অনেক হিসাব ঘোলা হয়ে গেছে। যেগুলো আগেভাগে খাতায় টুকে রেখেছিলেন সেগুলোই কেবল ফিরে পেলেন, বাকিটা হারিয়ে গেল। তাই তিনি এখন গুরুত্বপূর্ণ হিসাবগুলো মাথায় রাখার পাশাপাশি একটা খাতাতেও লিখে রাখেন।

এটাই আসলে Redis। রহিম মিয়ার মাথা হলো RAM — সব ডেটা সেখানেই থাকে বলে এটা একটা **in-memory store**, আর তাই উত্তর আসে বিদ্যুৎবেগে (এই **speed**-টাই Redis-এর আসল জোর)। জিনিসের নাম ধরে জিজ্ঞেস করাটা হলো **key** দিয়ে খোঁজা — নাম বললেই মান পাওয়া, ঠিক **key-value** মডেল। আর জ্বরে হিসাব হারানোটা হলো **volatility**: RAM-এর ডেটা power চলে গেলে মুছে যায়, খাতায় (disk-এ) লিখে না রাখলে ফেরত পাওয়া যায় না। বাস্তবে এই কারণেই Redis-কে বেশি ব্যবহার করা হয় cache আর session storage-এর মতো কাজে — যেখানে দ্রুত উত্তর দরকার, আর মূল সত্যটা (source of truth) database-এ থেকেই যায়।
