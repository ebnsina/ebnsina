...
রহিমের একটা স্টেশনারি-হার্ডওয়্যারের দোকান, আর তার কাউন্টারের ডেস্ক-অর্গানাইজারটাই পুরো দোকান চালানোর মগজ। ডেস্কের ঠিক সামনে একটা পিনবোর্ডে একটাই কাগজ সাঁটা — আজকের ডলারের রেট। একটাই মান, দরকার হলে খুলে নতুন রেট লিখে আবার সাঁটে। ডান পাশে একটা লোহার শিক (স্পাইক), খদ্দেরদের অর্ডার-স্লিপ যে ক্রমে আসে সেই ক্রমেই গেঁথে জমে; রহিম নিচের দিক থেকে একটা করে তুলে সিরিয়ালি কাজ সারে। এর পাশে কাঠের পিজিয়ন-হোল — প্রতিটা খোপে একটা লেবেল আর তার বিপরীতে একটা মান: "সাপ্লায়ার-ফোন", "দোকান-ঠিকানা", "লাইসেন্স-নম্বর"। একটা খোপের মান বদলাতে বাকিগুলো ছুঁতেও হয় না।

আরও দুটো জিনিস আছে। একটা টিনের বাক্সে রহিম আজ যেসব পাইকারের কাছ থেকে মাল তুলেছে তাদের নাম ফেলে রাখে — একই নাম দুবার ফেললে বাক্স সেটা নেয় না, তাই ভেতরে সবসময় ইউনিক নামগুলোই থাকে, ক্রম নিয়ে মাথাব্যথা নেই। আর দেয়ালে ঝোলানো একটা স্কোরবোর্ড — কোন পণ্য এ মাসে কত বিক্রি হলো, পয়েন্ট অনুযায়ী উপর থেকে নিচে সাজানো; নতুন বিক্রি যোগ হলেই বোর্ড নিজে থেকে ক্রম ঠিক করে নেয়, ফলে "টপ ৫ বেস্টসেলার" এক নজরেই দেখা যায়।
