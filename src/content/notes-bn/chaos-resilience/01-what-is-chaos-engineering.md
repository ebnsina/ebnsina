...
ইবনে সিনা একটা বড় অফিস বিল্ডিংয়ের ফায়ার মার্শাল। তিনি জানেন, আসল আগুন লাগার দিন সবকিছু ঠিকঠাক কাজ করবে কি না সেটা আন্দাজে ছেড়ে দেওয়া বোকামি। তাই তিনি আগে থেকে একটা দিন ঠিক করে ইচ্ছাকৃতভাবে fire alarm বাজিয়ে দেন — নিয়ন্ত্রিত একটা fire drill। উদ্দেশ্য একটাই: দেখা যে exit-এর দরজাগুলো সত্যিই খোলে কি না, extinguisher-গুলোয় চাপ আছে কি না, আর কর্মীরা আতঙ্কিত না হয়ে শান্তভাবে বেরিয়ে আসতে পারে কি না।

আর ঠিক তখনই ফাঁকগুলো ধরা পড়ে। তৃতীয় তলার একটা emergency exit-এ মালপত্র জমিয়ে রাখা, দরজাই খোলে না। দুটো extinguisher-এর মেয়াদ শেষ। নতুন কর্মী ফাতিমা আল-ফিহরি জানতেনই না কোন সিঁড়ি দিয়ে নামতে হয়। এগুলো এখন জানা গেল — একটা শান্ত, পরিকল্পিত মহড়ায়, যখন কেউ বিপদে নেই। আসল আগুনের ধোঁয়ার মধ্যে এই আবিষ্কারগুলো হলে প্রাণ যেত।

এই গল্পটাই আসলে **chaos engineering**। পরিকল্পিত fire drill হলো একটা chaos experiment — নিয়ন্ত্রিত পরিস্থিতিতে ইচ্ছাকৃতভাবে **fault injection**। exit, alarm আর কর্মীদের যাচাই করা হলো সিস্টেমের দুর্বলতা প্রোব করা, আর মহড়ায় ফাঁক খুঁজে পাওয়া হলো আসল **outage**-এর আগেই দুর্বলতা ধরে ফেলা — তখন ঠিক করার সময় আছে, চাপ নেই। বাস্তবে Netflix এই কাজটাই করে তাদের Chaos Monkey দিয়ে — production-এ এলোমেলোভাবে সার্ভার বন্ধ করে দেখে সিস্টেমের **resilience** টেকে কি না, ইউজাররা টের পাওয়ার আগেই।
