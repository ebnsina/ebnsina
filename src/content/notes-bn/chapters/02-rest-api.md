...
রহিমের একটা ভাতের হোটেল, দেয়ালে ঝোলানো একটা ছাপানো মেনু — কী কী পদ আছে, প্রতিটার দাম, সব ফিক্সড। করিম গিয়ে বসল। প্রথমে জানতে চাইল আজ কাচ্চি আছে কিনা, ওয়েটার মেনু দেখিয়ে দিল — এটা নিছক দেখা, কিছু বদলায় না। তারপর করিম এক প্লেট কাচ্চির অর্ডার দিল, ওয়েটার নতুন একটা অর্ডার স্লিপ কাটল। খানিক পরে সে মত বদলে বলল, প্লেটটা দুই থেকে বাড়িয়ে তিন করে দাও — পুরনো অর্ডারটাই সে বদলে দিল, নতুন করে কিছু শুরু হলো না। শেষে ফাতেমা ফোন করে বলল দেরি হবে, তখন করিম একটা অর্ডার একেবারে বাতিল করে দিল।

ওয়েটার প্রতিবার পরিষ্কার জবাব দেয়। খাবার টেবিলে চলে এলে বলে "স্যার, সার্ভ করা হয়েছে"। মেনুতে নেই এমন পদ চাইলে বলে "দুঃখিত, এই আইটেম আমাদের নেই"। আর রান্নাঘরে গ্যাস শেষ বা বাবুর্চি নেই — এমন গোলমাল হলে বলে "ভেতরে একটু সমস্যা, একটু পরে আসুন"। গুরুত্বপূর্ণ ব্যাপার হলো, মেনুটা সবার সামনে টাঙানো — করিম, রহিম, ওয়েটার সবাই জানে কী চাওয়া যায় আর কীভাবে চাইতে হয়। মেনু নিয়ে কারো আলাদা করে তর্ক করতে হয় না।
