...
শুক্রবার সন্ধ্যা, রহিমের রেস্টুরেন্টে ঠাসা ভিড়। ওয়েটার করিম টেবিলে টেবিলে ঘুরে অর্ডার নিচ্ছে — কাচ্চি, রোস্ট, বোরহানি — আর প্রতিটা অর্ডার একটা কাগজের টিকিটে লিখে কিচেনের সামনের টিকিট রেলে ক্লিপ দিয়ে ঝুলিয়ে দিচ্ছে। করিম টিকিট ঝুলিয়েই পরের টেবিলে ছুটছে, রান্না শেষ হওয়ার জন্য দাঁড়িয়ে থাকছে না। ভেতরে রাঁধুনি ফাতেমা একটা একটা করে টিকিট রেল থেকে টেনে নিয়ে নিজের গতিতে রান্না করছে। ভিড়ের ঝাপটায় করিম মিনিটে দশটা অর্ডার আনলেও কিচেন থমকে যায় না — টিকিটগুলো রেলে জমা থাকে, ফাতেমা একটু পিছিয়ে পড়লেও পরে ধরে ফেলে।

আর গুরুত্বপূর্ণ ব্যাপার হলো, ফাতেমা রান্না শেষ করে ডিশটা কনফার্ম না করা পর্যন্ত টিকিটটা রেল থেকে খোলা হয় না। এতে যদি মাঝপথে ফাতেমার হাত ফসকে যায় বা রান্না নষ্ট হয়, টিকিটটা রেলেই ঝুলে থাকে বলে আরেকবার রান্না হয়ে যায় — কোনো অর্ডার হারায় না। যদি টিকিট খুলে ফেলার পর ডিশটা পড়ে যেত, তাহলে গেস্ট বসেই থাকত, কেউ জানতই না।

এই গল্পটাই আসলে **message queue**। ওয়েটার করিম হলো **producer** (দ্রুত অর্ডার জমা দেয়), টিকিট রেল হলো queue (spike-এর সময় অর্ডার বাফার করে রাখে), আর রাঁধুনি ফাতেমা হলো **consumer** (নিজের গতিতে একটা একটা প্রসেস করে) — দ্রুত producer আর ধীর consumer এভাবে decouple হয়ে যায়, একে অন্যের জন্য বসে থাকে না। ডিশ কনফার্ম হওয়ার পর টিকিট খোলাটাই **ack**, আর নষ্ট হলে রেলে ঝুলে থেকে আবার রান্না হওয়াটাই **retry**। বাস্তবে RabbitMQ বা Kafka দিয়ে ঠিক এভাবেই ট্রাফিক স্পাইক সামলে ব্যাকগ্রাউন্ড কাজ প্রসেস করা হয়।
