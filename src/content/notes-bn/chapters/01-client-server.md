...
রহিম একটা রেস্টুরেন্টে ঢুকে টেবিলে বসল। সে নিজে কিন্তু কিচেনে গিয়ে রান্না করতে যায় না — খাবার কীভাবে বানানো হচ্ছে সেটা নিয়েও তার মাথাব্যথা নেই। সে শুধু ওয়েটার করিমকে ডেকে বলল, "একটা কাচ্চি বিরিয়ানি দেন।" করিম অর্ডারটা লিখে নিয়ে কিচেনে গিয়ে শেফ ফাতেমাকে দিয়ে এল। ফাতেমা কিচেনে বসে বিরিয়ানিটা রান্না করল, প্লেটে সাজাল, আর করিমের হাতে তুলে দিল। করিম প্লেটটা নিয়ে রহিমের টেবিলে পৌঁছে দিল।

মজার ব্যাপার হলো, রহিম আর ফাতেমা কেউ কারো সাথে সরাসরি কথা বলল না — সব যাওয়া-আসা হলো করিমের মাধ্যমে। রহিম শুধু জানে কী চাইতে হবে; ফাতেমা শুধু জানে কীভাবে বানাতে হবে। দুজনের কাজ আলাদা, আর করিম মাঝখানে থেকে অর্ডার আর প্লেট এদিক-ওদিক করে দিল।

এই গল্পটাই আসলে **client-server আর্কিটেকচার**। রহিম হলো client — সে request (অর্ডার) পাঠায় কিন্তু নিজে কাজটা করে না। ফাতেমার কিচেন হলো server — সে request প্রসেস করে response (খাবার) ফেরত দেয়। আর ওয়েটার করিম হলো network, যে request আর response দুই দিকেই বয়ে নিয়ে যায়। এই আলাদা-আলাদা roles-এর কারণেই আপনার ব্রাউজার (client) জানে না Facebook-এর server ভেতরে কীভাবে ডেটা খোঁজে — সে শুধু request পাঠায় আর response পায়।
