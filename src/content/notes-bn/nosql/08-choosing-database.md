...
করিমের একটা ছোট ট্রাভেল এজেন্সি। একদিন এক খদ্দের এসে বলল, "ভাই, মোড়ের ফার্মেসিতে একটা ওষুধ আনতে হবে, দুই মিনিটের পথ।" করিম তার জন্য রিকশা ডেকে দিল — সস্তা, কাছেই, লাইনও নেই। পরের খদ্দের এল আসবাবপত্রসহ বাসা বদলাবে, ভারী মালামাল; করিম এবার ট্রাক ঠিক করল। এরপর এল চল্লিশজনের একটা স্কুল পিকনিক দল — তাদের জন্য একটা বাস, কারণ চল্লিশজনকে রিকশায় তোলা যায় না। আর যখন রহিম নদীর ওপারে জরুরি পৌঁছাতে চাইল, করিম স্পিডবোট ঠিক করল, কারণ ওখানে বাস-ট্রাক কোনোটাই চলে না।

করিম কখনো "সবচেয়ে ভালো বাহন কোনটা?" নিয়ে মাথা ঘামায় না — কারণ এমন কিছু নেই। রিকশায় ভারী আলমারি তোলা যায় না, আর দুই মিনিটের পথে ট্রাক ডাকলে টাকা আর সময় দুটোই নষ্ট। এমনকি ফাতেমা যখন সপরিবারে হজে গেল, এক বাহনে হলো না — বাসা থেকে স্টেশন রিকশায়, শহর থেকে শহর বাসে, তারপর সাগর পেরোতে প্লেন। এক যাত্রার আলাদা আলাদা অংশের জন্য আলাদা আলাদা বাহন।

এই গল্পটাই আসলে **সঠিক database বেছে নেওয়া**। প্রতিটা বাহন যেমন একটা নির্দিষ্ট যাত্রার সাপেক্ষে সেরা, প্রতিটা store তেমন একটা নির্দিষ্ট **workload আর access pattern**-এর সাপেক্ষে সেরা — transaction আর integrity চাইলে relational, জানা key দিয়ে দ্রুত lookup চাইলে key-value, nested entity চাইলে document, বিশাল write volume-এ wide-column, আর relationship-প্রথম প্রশ্নে graph। সর্বজনীনভাবে সেরা কোনো database নেই; বাহন বেছে নেওয়ার আগে যাত্রাটা পড়ে ফেলতে হয়। আর ফাতেমার হজযাত্রার মতো, বড় সিস্টেমে প্রায়ই এক store-এ কুলোয় না — বাস্তবে একটা e-commerce সাইট একসাথেই transaction-এর জন্য SQL (PostgreSQL), cache আর session-এর জন্য Redis, আর পণ্য খুঁজতে একটা search engine (Elasticsearch) চালায়। এই ইচ্ছাকৃত মেলবন্ধনটাই **polyglot persistence**।
