...
topics: ['ride hailing', 'dispatch', 'geospatial index', 'h3', 'matching', 'state machine', 'surge pricing', 'system design project']
---
...
export class DispatchService {
	...
	private async buildCandidates(req: RideRequest): Promise<Candidate[]> {
		...
		for (const driver of nearby) {
			...
			const score =
				0.55 * etaTerm + 0.2 * acceptance + 0.2 * idleTerm - (declined ? 0.5 : 0);
...
**Claim আগে, অফার পরে।** পুরো race fix-টা এই ক্রমটাতেই। উল্টো করলে — আগে অফার, accept এলে claim — দুজন চালকের ফোনে দুটো স্ক্রিন আসবে আর একজন হারবে *সিদ্ধান্ত নেওয়ার পরে*, যেটা অনেক বেশি বিরক্তিকর।
