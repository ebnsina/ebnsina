...
ফাতিমার একটা কাপড়ের ব্র্যান্ড, শহরের পনেরোটা এলাকায় তার দোকান — আর সামনের মাসে আরও কয়েকটা খুলবে। এতদিন প্রতিটা দোকানের জন্য আলাদা আলাদা প্রবেশ-পাস বানাতে হতো; নতুন দোকান খুললেই আবার নতুন পাসের জন্য দৌড়াতে হতো। ক্লান্ত হয়ে ফাতিমা নোটারির কাছে গেলেন একটাই master pass চাইতে — এমন একটা পাস যা তার ব্র্যান্ডের যেকোনো শাখায় (এখনকার আর ভবিষ্যতের সবগুলোতেই) খাটবে।

নোটারি বললেন, "এত ব্যাপক একটা পাস আমি যেনতেনভাবে দিতে পারি না। তুমি শুধু একটা দোকানের সামনের জানালায় সই ঝুলিয়ে প্রমাণ দিলে হবে না — তাতে তো কেবল ওই একটা দোকানের দখল প্রমাণ হয়। তোমাকে যেতে হবে কেন্দ্রীয় ব্র্যান্ড রেজিস্ট্রিতে, যেটা তোমার সব শাখা নিয়ন্ত্রণ করে, আর সেখানে একটা official প্রমাণপত্র ঝুলিয়ে দেখাতে হবে যে গোটা ব্র্যান্ডটাই তোমার।" ফাতিমা রেজিস্ট্রিতে প্রমাণ ঝোলালেন, নোটারি যাচাই করলেন, আর একটাই master pass পেয়ে গেলেন — যা প্রতিটা শাখায় খাটে।

এই গল্পটাই আসলে **wildcard certificate**। ফাতিমার একটা master pass যা প্রতিটা শাখায় খাটে, সেটাই একটা `*.example.com` cert — একটাই certificate দিয়ে সব subdomain কভার হয়ে যায়। একটা দোকানের জানালায় সই ঝোলানো যথেষ্ট না হওয়াটাই হলো কেন per-host HTTP-01 এখানে চলে না — সেটা তো কেবল একটা host-এর দখল প্রমাণ করে। আর কেন্দ্রীয় ব্র্যান্ড রেজিস্ট্রিতে official প্রমাণ ঝোলানোটাই **DNS-01 challenge** — domain-এর DNS-এ একটা নির্দিষ্ট **TXT record** বসিয়ে প্রমাণ করা যে গোটা domain-টাই আপনার, একটা host নয়। বাস্তবেও ঠিক এই কারণেই Let's Encrypt wildcard cert কেবল DNS-01-এর মাধ্যমেই ইস্যু করে — whole-domain control ছাড়া এত সুইপিং একটা cert দেওয়া নিরাপদ নয়।
