...
সিনা শহরের বাইরে থাকে, তার একটা বাড়ি আছে গ্রামে। বাড়ির রঙ চটে গেছে, তাই সে খোয়ারিজমিকে বলল, "ভাই, আমার বাড়িটা একটু রং করিয়ে দে তো।" এখন খোয়ারিজমিকে তো কাজটা করতে হলে জানতে হবে বাড়িটা ঠিক কোথায়। সিনা একটা কাগজে বাড়ির পুরো ঠিকানা লিখে খোয়ারিজমির হাতে দিল — গ্রামের নাম, রাস্তার নাম, বাড়ির নম্বর। খোয়ারিজমি সেই ঠিকানা ধরে গ্রামে গেল, আসল বাড়িটা খুঁজে বের করল, আর দেয়ালে নতুন রং লাগিয়ে দিল। সিনা পরে গিয়ে দেখল — বাহ, তার আসল বাড়িটাই সত্যিই ঝকঝকে হয়ে গেছে।

এবার উল্টোটা ভাবুন। সিনা যদি খোয়ারিজমিকে ঠিকানা না দিয়ে বাড়ির একটা ছবির ফটোকপি হাতে দিত আর বলত "এটা রং কর"? খোয়ারিজমি কাগজের ওই ছবিতে যত সুন্দর করেই রং বুলাক না কেন, গ্রামের আসল বাড়ির একটা ইটও বদলাবে না। কারণ সে তো শুধু একটা কপি নিয়ে কাজ করছে, আসল জিনিসটার নাগাল তার হাতে নেই।

এই গল্পটাই আসলে **pointer**। বাড়ির ঠিকানা লেখা কাগজটাই হলো pointer — সে নিজে বাড়ি না, বাড়িটা কোথায় আছে সেই **address** ধরে রাখে। ঠিকানা (pointer) হাতে পেলে খোয়ারিজমি আসল বাড়িটাই (original value) বদলাতে পারে। আর ফটোকপি দেওয়া মানে একটা **value copy** পাস করা — Go-তে ডিফল্টে ফাংশনে সবকিছু এভাবেই copy হয়ে যায়, তাই কপিতে করা পরিবর্তন আসলটায় লাগে না। বাস্তবে কোনো ফাংশনকে যখন আপনি আসল ডেটা বদলাতে দিতে চান — যেমন একটা struct-এর field আপডেট করা — তখন value পাঠানোর বদলে তার address, মানে pointer, পাঠান।
