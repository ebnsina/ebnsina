...
ফাতিমার রান্নাঘরে তাকের উপর সারি সারি কাচের বয়াম, প্রতিটার গায়ে স্পষ্ট লেবেল সাঁটা — একটায় লেখা "চিনি", পাশেরটায় "লবণ", তারপর "হলুদ", "মরিচ"। চিনির বয়ামে শুধু চিনিই থাকে, আর কিছু না। একদিন সিনা রান্নায় হাত লাগাতে এসে ভুল করে লবণের চামচ চিনির বয়ামে ঢালতে গেল, ফাতিমা সাথে সাথে হাত ধরে ফেলল — "এই বয়াম চিনির, এতে লবণ ঢোকানো যাবে না।" প্রতিটা বয়াম আগেই ঠিক করা কোন জিনিসের জন্য, আর সেটা বদলায় না।

রান্নার সময় ফাতিমা রেসিপি ধরে ধরে এগোয়। "ঝোল যদি বেশি পাতলা হয়, আরেকটু জ্বাল দাও" — এটা একটা শর্ত। "যতক্ষণ না পেঁয়াজ সোনালি হয়, নাড়তে থাকো" — এটা একটা পুনরাবৃত্তি। আবার আজ কী রান্না হবে সেটার উপর নির্ভর করে ধাপ বদলায়: মাংস হলে এক পথ, মাছ হলে আরেক পথ, ডাল হলে অন্য পথ — যেটা মেলে সেই ধাপেই সে ঢোকে।

এই গল্পটাই আসলে Go-র বিল্ডিং ব্লক। লেবেল সাঁটা বয়াম হলো **static typing** — প্রতিটা variable আগেই ঠিক করা একটা type-এর মান ধরে রাখে (চিনির বয়াম মানে `string`, লবণের বয়াম মানে `int`), আর ভুল type ঢোকাতে গেলে compiler ফাতিমার মতোই হাত ধরে ফেলে। বয়ামগুলো নিজেই হলো **variable**, আর রেসিপির শর্ত-পুনরাবৃত্তি-বাছাই হলো **control flow** — `if` দিয়ে শর্ত, `for` দিয়ে লুপ, `switch` দিয়ে অনেক পথের মধ্যে একটা বাছাই। বাস্তবেও ঠিক এ কারণেই Go-তে ভুল type-এর অনেক bug কোড চালানোর আগেই compile time-এ ধরা পড়ে, প্রোডাকশনে গিয়ে ক্র্যাশ করে না।
