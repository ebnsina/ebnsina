...
সিনার দর্জির দোকানে সকাল থেকে ভিড়। ও লক্ষ্য করেছে, প্রায় প্রতিটা পাঞ্জাবিতে একই ধরনের কলার আর হাতার কাফ লাগে। তাই ও ফাঁকা সময়ে কয়েক ডজন কলার আর কাফ আগেই কেটে-সেলাই করে একটা বাক্সে রেখে দেয়। নতুন অর্ডার এলে পুরো পাঞ্জাবি শূন্য থেকে বানায় না — শুধু শরীরের কাপড়টা সেলাই করে, আর বাক্স থেকে বানানো কলার-কাফ বসিয়ে দেয়। এই আগে থেকে বানানো টুকরোগুলো বারবার কাজে লাগানোই হলো fragment caching। আবার খোয়ারিজমি ভাই যখন দ্বিতীয়বার আসেন, সিনা নতুন করে ফিতা দিয়ে মাপ নেয় না — খাতা খুলে গতবারের বুক-কোমর-হাতার মাপ দেখে নেয়। একই মানুষের একই মাপ বারবার না মেপে আগের হিসাবটা মনে রাখা — এটাই memoization।

দোকানের এক কোণে সিনার একটা ড্রয়ার আছে, যেখানে প্রতিটা নিয়মিত খদ্দেরের আলাদা ফাইল — ফাতিমা খালার পছন্দের কাপড়, খোয়ারিজমির মাপ, আগের বকেয়া। যতক্ষণ মানুষটা নিয়মিত আসেন ততক্ষণ ফাইল থাকে, অনেকদিন না এলে ফাইল সরিয়ে দেওয়া হয় — ঠিক TTL-এর মতো। এটাই session store। আর দেয়ালে ঝোলানো একটা কাগজে সিনা বড় করে লিখে রেখেছে যে সবাই বারবার জিজ্ঞেস করে: "কাফটিং চার্জ কত, ডেলিভারি কবে।" প্রতিবার মুখে উত্তর না দিয়ে ও কাগজটা দেখিয়ে দেয় — এটাই query-result cache, একটা বারবার আসা প্রশ্নের উত্তর একবার হিসাব করে জমিয়ে রাখা।
