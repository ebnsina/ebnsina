...
**"Pick two of three" is wrong.** P is a fact of nature, not a design choice — you must tolerate partitions. CAP really says: *during a partition*, choose C or A. The rest of the time the trade-off does not even apply. Read CAP as a statement about behavior under partition, not a menu.
