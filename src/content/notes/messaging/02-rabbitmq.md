...
বাগদাদের বড় ডাকঘরে সকাল থেকেই মানুষজন চিঠি জমা দিতে ভিড় করে। কেউ সরাসরি কোনো পিয়নের হাতে চিঠি গুঁজে দেয় না — সব চিঠি গিয়ে জমা হয় প্রধান সর্টার খোয়ারিজমির টেবিলে। তিনি প্রতিটি চিঠির খামের ঠিকানার লেবেল পড়েন, আর তার সামনের দেয়ালে সাজানো অনেকগুলো পিজিয়ন-হোলের মধ্যে ঠিক কোনটায় সেটা ফেলতে হবে তা নিয়ম দেখে বুঝে নেন। "কর্ডোভা" লেবেল দেখলে চিঠি যায় একটা নির্দিষ্ট হোলে; আবার "সবাইকে জানাও" লেবেলের নোটিশ পেলে তিনি সেটার কয়েকটা কপি বানিয়ে একসাথে অনেকগুলো হোলে ফেলে দেন।

প্রাপকরা — সিনা, ফাতিমা — নিজেদের হোল থেকে চিঠি তোলেন, কিন্তু এখানে একটা নিয়ম আছে: চিঠি তোলার সময় খাতায় সই না করা পর্যন্ত সেটা "বিতরণ হয়ে গেছে" বলে গণ্য হয় না। কেউ চিঠি হাতে নিয়েও যদি সই না করে হুট করে চলে যায়, চিঠিটা হোলেই থেকে যায় — পরে আরেকজন এসে সেটা তুলতে পারে। কোনো চিঠিই সইয়ের আগে হারিয়ে যায় না।

এই গল্পটাই RabbitMQ। প্রধান সর্টার খোয়ারিজমি হলো **exchange** — producer সরাসরি queue-তে না দিয়ে সবকিছু এখানেই জমা দেয়। খামের ঠিকানার লেবেল হলো **routing key**, আর "কোন লেবেল কোন হোলে যাবে" সেই নিয়মটা হলো **binding**। প্রতিটা পিজিয়ন-হোল একেকটা **queue**। আর সই না করা পর্যন্ত চিঠি বিতরণ-সম্পূর্ণ না ধরাটাই **ack** (acknowledgement) — consumer কাজ শেষ করে ack না দিলে RabbitMQ মেসেজটা মুছে ফেলে না, বরং আবার আরেক consumer-কে দেয়। বাস্তবে ঠিক এভাবেই একটা মেসেজ processing-এর মাঝপথে consumer ক্র্যাশ করলেও কাজটা হারিয়ে যায় না।
