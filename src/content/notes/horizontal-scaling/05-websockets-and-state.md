...
খোয়ারিজমি একটা বিশাল কাস্টমার-সাপোর্ট হলের ম্যানেজার। সারি সারি ডেস্কে অনেক এজেন্ট বসে আছে, আর প্রতিটা কলার একটা লম্বা খোলা কলে একজন নির্দিষ্ট এজেন্টের সাথে আটকে থাকে — কলটা যতক্ষণ চলে, ঐ একজন এজেন্টই কলারের সব কথা শোনে, লাইনটা তার হাতেই খোলা থাকে। সিনা যদি আজ কল করে ফাতিমার লাইনে যুক্ত হয়, তার পুরো কথোপকথনের ইতিহাস, প্রসঙ্গ — সবই এখন শুধু ফাতিমার মাথায়। পাশের সারির কোনো এজেন্ট হঠাৎ সিনার কল ধরলে সে কিছুই জানে না, শূন্য থেকে শুরু করতে হবে।

তাই খোয়ারিজমি দুটো নিয়ম চালু করল। প্রথমত, সিনা কল কেটে আবার ফোন করলে অপারেটর তাকে যেন আবার ফাতিমার ডেস্কেই পাঠায় — যার কাছে তার খোলা লাইনটা আছে, নয়তো প্রসঙ্গ হারিয়ে যাবে। দ্বিতীয়ত, ধরো একটা জরুরি বার্তা এসেছে যেটা সিনাকে পৌঁছে দিতে হবে, কিন্তু বার্তাটা হাতে পেয়েছে অন্য সারির বিরুনি। বিরুনি তো সরাসরি সিনার লাইনে ঢুকতে পারে না। তাই হলের মাঝখানে একটা কমন ইন্টারকম বসানো হলো — বিরুনি ইন্টারকমে ঘোষণা দেয় "সিনার জন্য বার্তা", পুরো হলের সব এজেন্ট সেটা শোনে, আর যার ডেস্কে সিনার খোলা লাইন আছে (ফাতিমা) সে রিলে করে দেয়।
