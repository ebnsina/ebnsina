...
চট্টগ্রামের এক বিশাল মেগা-পোর্টের অপারেশনস HQ-তে placement chief সিনা। দিনে হাজার হাজার শিপিং কন্টেইনার নামে, আর তার কাজ প্রতিটা কন্টেইনারকে এমন একটা yard-এ বসানো যেখানে সত্যিই জায়গা খালি আছে — একটা 40-ফুট কন্টেইনার যদি প্রায় ভরা yard-এ ঠেলে ঢোকানো হয়, বাকি কন্টেইনারগুলোর নামানোই আটকে যায়। তাই সে প্রতিটা কন্টেইনারের মাপ দেখে খালি slot-এ টানটান করে সাজায়, একটুও ফাঁকা নষ্ট না করে। কিন্তু এই স্কেলে একটা ছোট ভুল packing নিয়ম — যেমন প্রতিটা লোডকে দরকারের দ্বিগুণ জায়গা বরাদ্দ দেওয়া — গোটা yard নষ্ট করে দেয়।

সিনা তাই প্রতিটা কন্টেইনারের জন্য একটা কড়া space ration ঠিক করে দেয়: তুমি এতটুকু জায়গার বেশি নিতে পারবে না, নাহলে এক অতিকায় লোড তার yard-mate-দের চেপে বের করে দেবে। জাহাজের ভিড় বাড়লে ম্যানেজার খোয়ারিজমি পাশের খালি yard খুলে দেয় আর অতিরিক্ত crane ভাড়া করে আনে; ভিড় কমলে সেগুলো ছেড়ে দেয় যাতে খরচ না বাড়ে। আর পুরো বন্দরটা আসলে একটা নয় — কয়েকটা আলাদা port complex, প্রতিটার নিজের yard আর crane; supervisor ফাতিমা সবগুলোকে একটাই অপারেশন হিসেবে চালান, যাতে এক জায়গায় জট লাগলে জাহাজ অন্য complex-এ পাঠানো যায়।
