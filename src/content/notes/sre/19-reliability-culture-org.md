...
শহরের বড় হাসপাতালটায় নতুন ডিরেক্টর সিনা যোগ দিয়ে দেখলেন, patient safety-র পুরো দায়িত্ব একজন লোকের কাঁধে — একলা "safety officer" খোয়ারিজমি। কিছু ভুল হলে সবাই তার দিকে আঙুল তোলে, আর ডাক্তার-নার্স-ওয়ার্ডবয়রা ভাবে "ওটা তো ওনার কাজ"। ফলে ভুল ওষুধ, ভুল ফাইল, ভুল বেড — চলতেই থাকে। সিনা একটা কথাই সবাইকে বোঝালেন: রোগীর নিরাপত্তা কারও একার কাজ না, এটা প্রতিটা ডাক্তার, নার্স, এমনকি স্ট্রেচার ঠেলা ওয়ার্ডবয়েরও shared responsibility। এখন থেকে যে কেউ — সিনিয়র সার্জন হোক বা নতুন নার্স — কোনো ঝুঁকি দেখলে হাত তুলে "থামুন" বলতে পারবে, আর তার জন্য কাউকে দোষারোপ করা হবে না।

সবচেয়ে বড় বদলটা এল ভুল সামলানোর ধরনে। আগে কোনো দুর্ঘটনা হলে খোঁজা হতো "কে করল", এখন খোঁজা হয় "কোন system-টা এই ভুলটা হতে দিল" — খোলাখুলি বসে সবাই মিলে কেস স্টাডি করে, শাস্তি নয়, শেখা। আর safety-র expert-দের সিনা তিন ভাবে সাজালেন: কয়েকজনকে সরাসরি ওয়ার্ডে বসিয়ে দিলেন যেন তারা টিমের সাথে মিশে কাজ করে, ফাতিমার নেতৃত্বে একটা central standards টিম বানালেন যারা সবার জন্য এক checklist আর protocol লেখে, আর কয়েকজনকে রাখলেন adviser হিসেবে — যারা শুধু পরামর্শ দেয়, চাপিয়ে দেয় না। কোনো একটা কড়া নিয়ম নয়, বরং এই পুরো ভাগ করে নেওয়া culture-টাই আসলে রোগীদের বাঁচিয়ে রাখল।
