...
ইবনে সিনার একটা রেস্টুরেন্ট, আর মেন্যুতে সবচেয়ে জনপ্রিয় একটাই পদ — কাবসা। মজার ব্যাপার হলো, উনি এই একই পদ চার ভাবে পরিবেশন করেন। প্রথম টেবিলে আল-খোয়ারিজমি এলে ওয়েটার কাঁচা উপকরণ — চাল, মশলা, মাংস — একটা ট্রেতে সাজিয়ে টেবিলেই একটা ছোট চুলা দিয়ে দেয়; খদ্দের নিজেই বসে রান্না করে খায়। দ্বিতীয় টেবিলে ফাতিমা আল-ফিহরি অর্ডার দিলে রান্নাঘরে তাজা করে পুরো প্লেট বানিয়ে গরম গরম সাজিয়ে দেওয়া হয় — যতবার অর্ডার, ততবার নতুন করে রান্না।

পাশেই একটা বুফে টেবিল, যেখানে সকালেই বড় ডেকচিতে একগাদা কাবসা রেঁধে সাজিয়ে রাখা হয়েছে; যে যখন আসে, নিজের প্লেটে তুলে নেয় — কাউকে রান্নার জন্য অপেক্ষা করতে হয় না, কিন্তু দুপুর গড়ালে খাবারটা একটু বাসি লাগে। আর ঠিক তার পাশের বুফে ট্রেটা ইবনে সিনা প্রতি ঘণ্টায় একবার নামিয়ে টাটকা করে আবার ভরে দেন — আগে থেকে রাঁধা, তবু নিয়ম করে সতেজ।
