...
সিনা একজন ব্যক্তিগত সংবাদপত্রের সম্পাদক। তার কাজটা অদ্ভুত — প্রতিটা পাঠকের জন্য সে আলাদা একটা ফ্রন্ট পেজ বানায়, যেখানে শুধু সেই পাঠক যে লেখকদের ফলো করে, তাদেরই খবর থাকে। খোয়ারিজমি যদি পাঁচজন সাধারণ কলাম-লেখককে ফলো করে, তাহলে সিনা চালাকিটা এভাবে করে: ওই সাধারণ লেখকদের কেউ যেই মুহূর্তে নতুন কিছু লেখে, সিনা সাথে সাথেই সেটা তাদের প্রতিটা follower-এর আগে থেকে সাজানো কাগজে বসিয়ে দেয়। ফলে খোয়ারিজমি সকালে কাগজ খুললেই তার পার্সোনালাইজড পেজ পুরো তৈরি — কোনো অপেক্ষা নেই।

কিন্তু ঝামেলা বাধে ফাতিমাকে নিয়ে। ফাতিমা এমন একজন জনপ্রিয় কলামিস্ট যাকে লাখ লাখ মানুষ ফলো করে। সে একটা লেখা লিখলে সিনাকে যদি লাখ লাখ কাগজে হাতে হাতে সেটা কপি করে বসাতে হয়, তাহলে সারাদিনেও কাজ শেষ হবে না। তাই ফাতিমার মতো হট লেখকদের বেলায় সিনা আগে থেকে কিছু বসায় না — বরং কোনো পাঠক যখন তার কাগজটা খোলে, ঠিক তখনই সিনা দৌড়ে গিয়ে ফাতিমার সাম্প্রতিক লেখা এনে সেই কাগজের সাধারণ খবরের সাথে জুড়ে দেয়। আর কোন খবরটা সবচেয়ে মজার বা প্রাসঙ্গিক, সেটা সিনা কাগজের একদম উপরে বসায়, কম গুরুত্বেরগুলো নিচে।

সিনাই এখানে **feed service**, আর প্রতিটা পাঠকের আলাদা কাগজ হলো তার **personalized feed**। সাধারণ লেখকদের খবর লেখামাত্রই সব follower-এর কাগজে আগে বসিয়ে রাখাটাই **fan-out on write**, আর ফাতিমার মতো celebrity/hot লেখকদের খবর পাঠক কাগজ খোলার মুহূর্তে এনে জোড়া দেওয়াটাই **fan-out on read** — এভাবেই সেই "একটা পোস্ট বনাম লাখ লাখ কপি" সমস্যা এড়ানো হয়। আর সবচেয়ে আকর্ষণীয় খবর উপরে বসানোটাই **ranking**। বাস্তবে Twitter/X আর Instagram ঠিক এই হাইব্রিড কৌশলেই কোটি কোটি মানুষের feed সামলায়।
