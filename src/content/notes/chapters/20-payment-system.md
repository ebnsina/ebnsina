...
সিনা একজন হুন্ডির ক্যাশ-কাউন্টার কেরানি — টাকা গোনা আর হিসাব রাখাই তার কাজ। তার সামনে একটা মোটা খাতা, যেটা সে চালায় কড়া double-entry নিয়মে: প্রতিটা টাকা যদি এক ঘর থেকে বেরোয়, তবে ঠিক সেই টাকা আরেক ঘরে ঢুকতেই হবে। খোয়ারিজমির ঘর থেকে ৫০০ টাকা কমল তো ফাতিমার ঘরে ৫০০ টাকা বাড়তেই হবে — এক পয়সা এদিক-ওদিক হলে দিনের শেষে খাতা মেলে না, আর সিনা বাড়ি যেতে পারে না। এই দুই-ঘরে-লেখাই তার হিসাব সবসময় শূন্যে ব্যালেন্স রাখে।

প্রতিটা পেমেন্ট স্লিপের গায়ে একটা করে ইউনিক serial নম্বর ছাপানো থাকে। খোয়ারিজমি যখন একটা স্লিপ নিয়ে আসে, সিনা প্রথমে serial-টা তার তালিকায় দেখে নেয়। ভিড়ের ঠেলায় বা লাইনের গণ্ডগোলে খোয়ারিজমি যদি ভুল করে একই স্লিপ দ্বিতীয়বার কাউন্টারে বাড়িয়ে দেয়, সিনা serial দেখেই চিনে ফেলে — "এইটা তো আগেই পাস করেছি" — আর দ্বিতীয়বার টাকা গোনে না, খাতাতেও দ্বিতীয় এন্ট্রি বসায় না। এক স্লিপে ঠিক একবারই টাকা যায়, কখনো দুইবার নয়। দিন শেষে সিনা তার খাতাটা ব্যাংকের statement-এর পাশে রেখে লাইন ধরে মেলায় — কোন এন্ট্রি বাদ পড়ল, কোথায় গরমিল, সব ধরা পড়ে।

এই পুরো গল্পটাই আসলে একটা **payment system**। স্লিপের ইউনিক serial হলো **idempotency key**, আর একই স্লিপ দুইবার এলে টাকা না গোনাটাই **exactly-once processing** — retry হলেও কাস্টমার দুইবার charge হয় না, no double-charge। সিনার দুই-ঘরে-লেখা খাতা হলো **double-entry ledger** (প্রতি debit-এর একটা মিলে যাওয়া credit), আর দিন শেষে ব্যাংকের statement-এর সাথে খাতা মেলানোই **reconciliation**। Stripe বা bKash-এর মতো আসল সিস্টেম ঠিক এভাবেই — idempotency key দিয়ে ডুপ্লিকেট আটকে, double-entry ledger-এ হিসাব মিলিয়ে, আর provider-এর সাথে reconcile করে — কোটি কোটি টাকা এক পয়সাও না হারিয়ে সরায়।
