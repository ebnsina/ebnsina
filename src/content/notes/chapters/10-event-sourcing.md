...
সিনার একটা মুদির দোকান। খদ্দের ফাতিমা প্রতি মাসে বাকিতে জিনিস নেয়, মাঝেমধ্যে টাকা শোধ করে। সিনা কোনোদিন খাতায় শুধু "ফাতিমার বাকি ৫০০ টাকা" লিখে রাখে না — বদলে সে খাতার পাতায় লাইন ধরে সব লিখে যায়: "১ তারিখ চাল নিল ৩০০", "৫ তারিখ শোধ দিল ২০০", "১০ তারিখ তেল নিল ৪০০"। প্রতিটা লেনদেন একটা আলাদা লাইন, আর সিনা পুরনো লাইন কখনো কাটে না বা বদলায় না — নতুন কিছু হলে শুধু নিচে নতুন লাইন যোগ করে। আজকের বাকি কত জানতে হলে সে উপর থেকে নিচ পর্যন্ত সব লাইন যোগ-বিয়োগ করে বের করে নেয়।

এতে মজাটা হলো — কোনোদিন ফাতিমা যদি বলে "গত মাসের ১৫ তারিখে আমার বাকি কত ছিল?", সিনা শুধু সেই তারিখ পর্যন্ত লাইনগুলো আবার যোগ করে হুবহু বলে দিতে পারে। ঝগড়া বাধলে খাতাই সাক্ষী, প্রতিটা লাইন ধরে দেখানো যায় কবে কী হয়েছিল। তবে প্রতিবার পুরো খাতা যোগ করা ঝামেলা, তাই সিনা দোকানের সামনে একটা ছোট বোর্ডে শুধু "ফাতিমার বর্তমান বাকি: ৫০০" লিখে ঝুলিয়ে রাখে — খাতা না খুলেই এক নজরে দেখা যায়। নতুন লেনদেন হলে বোর্ডের সংখ্যাটা সে আপডেট করে দেয়, কিন্তু আসল সত্য থাকে খাতাতেই।

সিনার খাতার প্রতিটা লাইনই হলো একটা **event**, আর কেবল যোগ করা যায় কাটা যায় না বলে এটা immutable log — ঠিক **event sourcing**-এর মূল কথা। সব লাইন যোগ করে আজকের বাকি বের করাটাই **replay** করে state আবার গড়ে তোলা, আর সামনের বোর্ডটা হলো **read model** যা দ্রুত পড়ার জন্য আলাদা রাখা — এটাই **CQRS**, যেখানে লেখা (খাতায় নতুন লাইন যোগ) আর পড়া (বোর্ড দেখা) আলাদা। বাস্তবে banking সিস্টেম আর audit log ঠিক এভাবেই কাজ করে — প্রতিটা transaction চিরস্থায়ীভাবে জমা থাকে, যেকোনো সময়ের অবস্থা replay করে বের করা যায়, আর নিয়ন্ত্রকদের কাছে সম্পূর্ণ হিসাব দেওয়া যায়।
