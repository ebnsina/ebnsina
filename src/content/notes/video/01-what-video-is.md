...
বুখারার একটা পুঁথি-চিত্রশালা। উস্তাদ ফাতিমার কর্মশালায় খলিফার ছেলের জন্য একটা অদ্ভুত জিনিস বানানোর ফরমায়েশ এসেছে — এমন একটা কাঠের বাক্স যার ভেতরে ছোট ছোট আঁকা কার্ড এক এক করে সরে যাবে, আর দেখলে মনে হবে একটা ঘোড়া সত্যিই ছুটছে। ফাতিমা বসে হিসাব করলেন। ঘোড়াটা তিন সেকেন্ড ছুটবে। চোখকে ধোঁকা দিতে হলে সেকেন্ডে অন্তত পঁচিশটা কার্ড লাগবে। মানে পঁচাত্তরটা কার্ড আঁকতে হবে — যার প্রতিটাই একেকটা সম্পূর্ণ স্থির ছবি। বাক্সটা যত জোরে ঘুরবে, ঘোড়া তত মসৃণ ছুটবে; আস্তে ঘুরলে ঝাঁকুনি লাগবে। কার্ডের সংখ্যা নয়, **প্রতি সেকেন্ডে কয়টা কার্ড** — এটাই আসল প্যারামিটার।
...
তারপর এল ক্রমের ঝামেলা। কার্ডগুলো আঁকা শেষ হলে সহকারী বিরুনি প্রতিটার পেছনে সংখ্যা লিখে দেয় — "এই কার্ডটা বাক্সে ছাব্বিশ নম্বরে দেখাবে"। কিন্তু কর্মশালায় আঁকার ক্রম আলাদা: কিছু কার্ড এমন যে তার আগের **আর** পরের কার্ড দুটো সামনে না থাকলে আঁকাই যায় না। তাই বিরুনি প্রতিটা কার্ডের পেছনে দুটো সংখ্যা লেখেন — একটা "কত নম্বরে দেখাবে", আরেকটা "কত নম্বরে আঁকতে হবে"। দুটো সংখ্যা মেলে না, আর সেটা ভুল নয়, ইচ্ছাকৃত।
...
দুটো আলাদা হয় কারণ কিছু frame এমন frame থেকে predict করা হয় যেগুলো playback-এর ক্রমে পরে আসে — তাই decoder-কে পরের frame-গুলো আগে পাঠাতে হয়। গল্পের বিরুনির দুই সংখ্যার ব্যাপারটা এখানেই। কেন এমন হয়, চ্যাপ্টার ২-তে বিস্তারিত আছে।
