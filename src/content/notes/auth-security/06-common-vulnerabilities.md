...
মিরপুরে সিনাদের একটা অ্যাপার্টমেন্ট বিল্ডিং, নিচে একজন দারোয়ান — খোয়ারিজমি। নিয়ম হলো, ভেতরে ঢুকতে হলে রেজিস্টারে নাম মিলিয়ে দারোয়ান একটা ভিজিটর পাস দেবে। কিন্তু এক চালাক লোক আগেভাগেই সিনাকে একটা পাস ধরিয়ে দিলো — "ভাই, এটা রেখে দেন, কাজে লাগবে।" সিনা কিছু না ভেবে সেটা নিয়েই ভেতরে গেল, আর সেই লোকটার কাছে ওই পাসের হুবহু নকল থেকে যাওয়ায় সিনার নামেই সে দিব্যি ঢুকে পড়ল। আরেকদিন একজন অচেনা লোক খোয়ারিজমির হাতে একটা চিরকুট দিলো — "৩-বি ফ্ল্যাটের পার্সেলটা এই লোককে দিয়ে দিন।" চিরকুটে ৩-বি'র বাসিন্দার সিলমোহর দেখে খোয়ারিজমি কিছু যাচাই না করেই পার্সেল দিয়ে দিলো — অথচ চিরকুটটা বাসিন্দা লেখেননি, সিলটা শুধু ধার করা।

খোয়ারিজমির আরেকটা অভ্যাস — কেউ আসল বাসিন্দার নাম বললে সে রেজিস্টারের পাতা উল্টে উল্টে খোঁজে, কয়েক সেকেন্ড লাগে; আর ভুয়া নাম বললে সঙ্গে সঙ্গে "নাই" বলে ফিরিয়ে দেয়। বাইরের একজন শুধু জবাব আসতে কত সময় লাগছে তা মেপেই বুঝে ফেলল কোন কোন নাম আসল। এদিকে ফাতিমা একদিন খেয়াল করলেন, তাঁর ১২-এ ফ্ল্যাটের চাবি দিয়ে পাশের ১২-বি'র দরজাও খুলে যায়, কারণ খোয়ারিজমি শুধু দেখে "ইনি কি বাসিন্দা?" — "এটা কি আপনারই ফ্ল্যাট?" তা কখনো মেলায় না।
