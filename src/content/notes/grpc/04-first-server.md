...
ফাতিমার রেস্তোরাঁয় রান্নাঘর আর ওয়েটার স্টেশনের মাঝখানে একটা দেয়াল। শুরুতে দুই পক্ষ বসে একটা কাগজে ঠিক করল — কোন কোন পদ অর্ডার করা যাবে, প্রতিটা পদের জন্য কী কী জানাতে হবে (টেবিল নম্বর, পরিমাণ), আর জবাবে কী ফেরত আসবে (কোন প্লেট, কী গার্নিশ)। এই লিখিত চুক্তিটাই সব — এর বাইরের কিছু চলবে না। এরপর খোয়ারিজমি নামের ছুতোর সেই কাগজ ধরে দুই দেয়ালে দুটো মিলে-যাওয়া অর্ডার জানালা কেটে বসাল: রান্নাঘরের দিকেরটা অর্ডার নেওয়ার জন্য, ওয়েটারের দিকেরটা অর্ডার পাঠানোর জন্য — একই মাপ, একই খোপ।

জানালা তো বসল, কিন্তু জানালার পেছনে কেউ না থাকলে তো কিছু রান্না হবে না। তাই রান্নাঘরের লোকজন জানালায় দাঁড়িয়ে প্রতিটা অর্ডার সত্যিই কেটেকুটে রান্না করে প্লেট সাজিয়ে দেয়। ফলে সিনা যখন ওয়েটার স্টেশন থেকে জানালায় ঝুঁকে "টেবিল তিন, দুটো কাবাব" বলে হাঁক দেয়, কিছুক্ষণ পর সাজানো প্লেট হাতে চলে আসে — যেন রান্নাঘরটা তার পাশেই দাঁড়িয়ে, অথচ সে দেয়ালের ওপারে কী হচ্ছে কিছুই জানে না।

এই গল্পটাই আসলে **প্রথম gRPC server আর client বানানো**। লিখিত মেনু-চুক্তিটা হলো `.proto`-এর **service definition** — কোন কোন method আছে আর প্রতিটার request/response কেমন। ছুতোরের দুই দেয়ালে মিলে-যাওয়া জানালা কেটে বসানোটা হলো **code generation** — একই `.proto` থেকে `protoc` server আর client দুই দিকের কোড বের করে দেয়। রান্নাঘরের লোক জানালায় দাঁড়িয়ে সত্যিই রান্না করাটা হলো **server-এ method implementation** (আমাদের `GetUser`, `CreateUser`)। আর সিনার হাঁক দিয়ে প্লেট পাওয়াটা হলো **client-এর remote method call** — `client.GetUser(...)` লেখাটা দেখতে সাধারণ Go function কলের মতো, অথচ ভেতরে দেয়ালের ওপারে অন্য process-এ কাজটা হচ্ছে। বাস্তবেও ঠিক এভাবেই microservice-গুলো একে অন্যের সঙ্গে কথা বলে — আগে `.proto` চুক্তি, তারপর দুই পাশের generated stub, তারপর remote call যেন local।
