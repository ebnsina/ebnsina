...
ফাতিমা একটা বড় কোম্পানির ভেতরের department-to-department হটলাইন নেটওয়ার্ক চালান — এক department-এর কেউ ফোন তুললেই অন্য department-এর কোনো agent-এর সাথে সরাসরি লাইন লেগে যায়। শুরুতে সব কল একজন agent-এর কাছেই যেত, ফলে সে হাঁপিয়ে উঠত আর বাকিরা বসে থাকত। ফাতিমা তাই একজন অপারেটর বসালেন — সিনা। এখন কল এলে সিনা দেখেন কোন কোন agent এই মুহূর্তে ফ্রি, আর কলগুলো তাদের মধ্যে ভাগ করে দেন, যাতে একজনের ঘাড়ে সব চাপ না পড়ে।

কিন্তু কিছু agent মাঝেমধ্যে ডেস্ক ছেড়ে চলে যায়, বা তাদের লাইন কেটে যায়। সিনা তাই প্রতি কয়েক সেকেন্ড পরপর প্রতিটা লাইনে একটা ছোট "আছেন তো?" পিং পাঠান — সাড়া না পেলে সেই লাইন তালিকা থেকে বাদ, কল আর ওদিকে যায় না। আবার প্রতিবার নতুন করে ডায়াল করতে সময় লাগে বলে তিনি ব্যস্ত agent-দের লাইনগুলো খোলা-গরম রেখে দেন, যাতে পরের কলেই সঙ্গে সঙ্গে কথা শুরু করা যায়। আর পাশে খোয়ারিজমি একটা খাতায় প্রতিটা কলের হিসাব টুকে রাখেন — কে কতক্ষণ কথা বলল, কোথায় লাইন কাটল — যাতে কোথাও সমস্যা হলে সেটা আগেভাগে ধরা যায়।

এই গল্পটাই production-এ gRPC চালানো। সিনার ফ্রি agent-দের মধ্যে কল ভাগ করা হলো একাধিক backend-এর উপর **load balancing**; প্রতি কয়েক সেকেন্ডের "আছেন তো?" পিং হলো **health check** (`grpc.health.v1.Health`, `livez`/`readyz`); লাইন খোলা-গরম রাখা হলো **keepalive** আর persistent **connection**; আর খোয়ারিজমির কলের খাতাই **observability** — log, metrics, trace। বাস্তবে এই কাজগুলো করে nginx/Envoy বা client-side round-robin (load balancing), gRPC health protocol (health check), `KeepaliveParams` (keepalive), এবং Prometheus + Loki + Tempo (observability) — যেগুলো এই চ্যাপ্টারে একে একে দেখব।
