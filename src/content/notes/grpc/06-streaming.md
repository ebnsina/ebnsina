...
শহরের একটা রেডিও স্টেশন, নাম ধরুন "রেডিও সমরকন্দ"। ফাতিমা একদিন এফএম ডায়াল ঘুরিয়ে স্টেশনটা একবার টিউন করলেন — ব্যস, ওই একটা কাজ করার পর সারা দুপুর একটার পর একটা গান, খবর, আবহাওয়া অনবরত তাঁর রেডিওতে আসতেই থাকল। তিনি আর কিছু চাইলেন না, শুধু বসে শুনে গেলেন; স্টেশন নিজে থেকেই একের পর এক জিনিস পাঠিয়ে গেল।

এদিকে মাঠপর্যায়ে সিনা একজন ফিল্ড রিপোর্টার। বন্যার খবর কাভার করতে গিয়ে তিনি ওয়াকিটকিতে অনবরত ছোট ছোট আপডেট পাঠাতে থাকলেন — "পানি বাড়ছে", "সেতু ডুবে গেছে", "লোকজন সরছে" — একটার পর একটা, অনেকক্ষণ ধরে। ডেস্কে বসা খোয়ারিজমি সবগুলো আপডেট জমা করলেন, আর শেষে সব মিলিয়ে একটাই গোছানো রিপোর্ট তৈরি করে সিনাকে ফেরত জানালেন "পেয়েছি, প্রচার হয়ে গেছে"। আর সন্ধ্যার লাইভ কল-ইন শোতে হোস্ট বিরুনি আর শ্রোতা — দুজনেই একসাথে কথা বলছেন, একজন থামার অপেক্ষায় অন্যজন বসে নেই; দুই দিক থেকেই কথা যাচ্ছে-আসছে।
