...
পুরনো ঢাকার এক গলিতে খোয়ারিজমির লন্ড্রি আর ড্রাই-ক্লিনের দোকান। আগে কাস্টমার এসে একটা লম্বা বাক্য বলত — "আমার সাদা শার্টটা ধুয়ে ইস্তিরি করে দেবেন", আর খোয়ারিজমি খাতায় পুরোটা লিখত। কিন্তু ভিড়ের সময় এত কথা লেখা-পড়ায় ভুল হতো, কে কোন কাপড় বলেছে গুলিয়ে যেত। তাই সে একটা ছোট টিকিট বানাল, যেখানে কয়েকটা নম্বর দেওয়া বাক্স আছে — বাক্স #১-এ কাপড়ের ধরন, #২-তে রং, #৩-তে সার্ভিস। কাস্টমার আর দোকানি দুজনের হাতেই একই নকশার টিকিট। এখন সিনা এসে শুধু একটা ছোট কোড-করা স্লিপ ধরিয়ে দেয় — "১: শার্ট, ২: সাদা, ৩: ওয়াশ+আয়রন" — লম্বা বাক্যের বদলে এক টুকরো ছোট্ট চিরকুট, যা দুজনেই হুবহু একইভাবে পড়ে।

মজার ব্যাপারটা হলো নম্বর নিয়ে। কয়েক মাস পরে দোকানে নতুন একটা সার্ভিস যোগ হলো — সুগন্ধি স্প্রে। খোয়ারিজমি টিকিটে বাক্স #৪ বসিয়ে দিল। কিন্তু ফাতিমার কাছে পুরনো ছাপানো টিকিট রয়ে গেছে যাতে বাক্স #৪ নেই — সমস্যা নেই, তার #১, #২, #৩ ঠিক আগের মতোই পড়া যায়, কারণ প্রতিটা তথ্য বাক্সের অবস্থান দিয়ে নয়, নম্বর দিয়ে চেনা হয়। নতুন টিকিট #৪ ভরে আনলেও পুরনো দোকানি যদি #৪ না চেনে, সে ওটা নীরবে এড়িয়ে বাকিটা ঠিকঠাক বুঝে নেয়।
