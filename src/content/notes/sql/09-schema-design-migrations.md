...
আল-খোয়ারিজমির একটা ছোট সরকারি সেবা অফিস। শুরুতে প্রতিটা কাজের জন্য আলাদা আলাদা এলোমেলো কাগজে তথ্য নেওয়া হতো, ফলে একই গ্রাহকের নাম-ঠিকানা দশটা ফর্মে দশবার লেখা থাকত — আর একজন ঠিকানা বদলালে সব জায়গা মেলানো অসম্ভব হয়ে পড়ত। তাই আল-খোয়ারিজমি বসে একটা পরিচ্ছন্ন ফর্ম ডিজাইন করল: প্রতিটা ঘর ঠিক একটা কাজের জন্য, একজন গ্রাহকের মূল তথ্য একবারই লেখা হয় আর বাকি কাগজে শুধু তার আইডি নম্বর বসে। কোন ঘর খালি রাখা যাবে না, ফোন নম্বর অবশ্যই লাগবে — নিয়মগুলো ফর্মেই ছাপানো, যাতে ভুল তথ্য ঢুকতেই না পারে।

মাস ছয়েক পর নতুন নিয়ম এল — এখন থেকে প্রত্যেকের একটা ইমেইল ঘরও লাগবে। আল-খোয়ারিজমি কাউন্টার বন্ধ করে দিল না। সে নতুন ফর্মে একটা বাড়তি ইমেইল ঘর যোগ করল, কিন্তু প্রথমে সেটা ঐচ্ছিক রাখল যাতে পুরনো ফর্মও চলতে থাকে। পেছনে একজন কর্মী ধীরে ধীরে পুরনো রেকর্ডগুলো নতুন ফরম্যাটে তুলে নিতে লাগল, আর কাউন্টারে ফাতিমা আল-ফিহরি দুই ফর্মেই তথ্য লিখে দুটোকে মিলিয়ে রাখল। সব রেকর্ড তোলা শেষ হলে তবেই ইমেইল ঘর বাধ্যতামূলক করা হলো, আর সবচেয়ে শেষে পুরনো ফর্মটা বাতিল করা হলো। কোনো একটা ধাপ ভুল হলে আগের ফর্মে ফিরে যাওয়ার পথও খোলা রাখা হয়েছিল।

গল্পটাই আসলে এই চ্যাপ্টার। পরিচ্ছন্ন ফর্ম, প্রতিটা ঘরে ঠিক এক তথ্য আর গ্রাহকের মূল তথ্য একবারই — এটাই ভালো **schema design** আর **normalization** (প্রতি fact একটা জায়গায়, ফর্মে ছাপানো নিয়মই হলো constraint)। কাউন্টার বন্ধ না করে ধাপে ধাপে নতুন ফর্মে সরে যাওয়া — নতুন **column** ঐচ্ছিক রেখে যোগ, পেছনে পুরনো রেকর্ড **backfill**, দুই ফর্মে একসাথে লেখা, তারপর পুরনোটা বাদ — এটাই zero-**downtime** **migration**-এর expand/contract প্যাটার্ন, আর ভুল হলে ফিরে যাওয়ার পথ রাখাটাই **rollback**-এর সুরক্ষা। বাস্তবে Postgres-এ একটা `email` column-কে ঐচ্ছিক ভাবে যোগ করে, batch-এ backfill করে, দুই দিকে লিখে, শেষে পুরনো column drop করে ঠিক এভাবেই লাখো ব্যবহারকারীর live database কোনো outage ছাড়াই বদলানো হয়।
