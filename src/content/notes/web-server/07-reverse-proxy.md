...
ফাতিমা একটা ব্যস্ত consultancy চালান, যেখানে পেছনের অফিসে বসেন কয়েকজন specialist — কেউ আইনের, কেউ হিসাবের, কেউ প্রকৌশলের। বাইরের কেউ কখনো সরাসরি তাঁদের কাছে পৌঁছাতে পারেন না। সব ফোন, সব চিঠি প্রথমে যায় ফাতিমার personal secretary সিনার কাছে। কেউ ফোন করলে সিনা শোনেন, তারপর নিজে থেকে সেই প্রশ্ন ভেতরে সঠিক specialist-এর কাছে পৌঁছে দেন, উত্তরটা নিয়ে ফিরে এসে কলকারীকে জানান। বাইরের লোকটা কখনো জানেই না ভেতরে আসলে কে কাজটা করল — তার কাছে সিনাই যেন গোটা প্রতিষ্ঠান।

সিনা শুধু চিঠি এদিক-ওদিক করেন না। সন্দেহজনক কল হলে তিনি আগেই ছেঁকে বাদ দেন, ভেতরের কাউকে বিরক্ত করেন না। আর যে প্রশ্নগুলো রোজ ঘুরেফিরে আসে — "অফিস কখন খোলে", "ফি কত" — সেগুলোর তৈরি উত্তর তিনি নিজের ডেস্কেই রেখে দেন, ভেতরে গিয়ে জিজ্ঞেস করার দরকারই পড়ে না। কেউ আবার গোপন কথা বলতে চাইলে সিনা লাইনটা নিরাপদে সামলান, তারপরই ভেতরে পাঠান।

এই সিনাই হলো **reverse proxy**। পেছনের হার্ড-টু-রিচ specialist-রা হলো আপনার **backend server** (upstream) — বাইরে থেকে কেউ সরাসরি তাদের ছুঁতে পারে না, secretary-র আড়ালেই তারা লুকানো ও সুরক্ষিত। প্রশ্ন ভেতরে **forward** করে উত্তর নিয়ে ফেরাটাই request/response proxy করা। নিরাপদ লাইনে কথা সামলানোটা **TLS termination**, আর রোজকার প্রশ্নের তৈরি উত্তর ডেস্কে রাখাটা **caching**। বাস্তবে ঠিক এভাবেই আপনার app server-গুলোর সামনে nginx বসে — client শুধু nginx-এর সাথে কথা বলে, nginx ভেতরের backend-এ request পৌঁছে দেয়, response ফেরত দেয়, আর backend-গুলোকে সরাসরি ইন্টারনেট থেকে আড়াল করে রাখে।
