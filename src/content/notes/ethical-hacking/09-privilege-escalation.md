...
খোয়ারিজমি একটা বড় অফিসের junior clerk। তার কাজ নির্দিষ্ট — সামনের ডেস্কে বসে ফাইল এন্ট্রি করা, নিজের কেবিনেটটুকু খোলা-বন্ধ করা। ম্যানেজারের ঘর, স্ট্রংরুম, সার্ভার রুম — এসব জায়গায় তার ঢোকার অনুমতি নেই। একদিন কাজের ফাঁকে সে খেয়াল করল, ম্যানেজার সিনা তাড়াহুড়োয় নিজের ড্রয়ার লক না করেই বেরিয়ে গেছেন, আর ভেতরে পড়ে আছে গোটা বিল্ডিংয়ের master key। ড্রয়ারের গায়ে সাঁটানো একটা sticky note-এ সাদা চোখে লেখা safe-এর কোড।

এই master key দিয়ে খোয়ারিজমি এখন যেকোনো দরজা খুলতে পারে, safe-এর কোড দিয়ে টাকার ভল্টও। সে চালাক বলে নয়, বরং permission hygiene নষ্ট বলেই হঠাৎ সেই junior clerk পুরো বিল্ডিংয়ের হর্তাকর্তা বনে গেল — যেখানে তার আসলে সামান্য একটা ডেস্কের বেশি কিছুতে হাত দেওয়ার কথাই ছিল না।
