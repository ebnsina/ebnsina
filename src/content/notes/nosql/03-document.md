...
ফাতিমা একজন ডাক্তার, নিজের চেম্বারে বসেন। প্রতিটা রোগীর জন্য তার একটা করে আলাদা ফোল্ডার — সিনার ফোল্ডারে সিনার সবকিছু: প্রেসক্রিপশন, ব্লাড টেস্টের রিপোর্ট, এক্স-রে, আর ফাতিমার হাতে লেখা নোট, সব ওই একটা ফোল্ডারের ভেতরেই গোছানো। সিনা চেম্বারে ঢুকলে ফাতিমা শুধু তার ফোল্ডারটা টেনে বের করেন, আর সাথে সাথেই পুরো ছবিটা চোখের সামনে — আগের অসুখ, চলতি ওষুধ, সব একসাথে। আলাদা আলাদা ড্রয়ার হাতড়ে টেস্ট রিপোর্ট আর প্রেসক্রিপশন জোড়া লাগাতে হয় না।

মজার ব্যাপার হলো, প্রতিটা রোগীর ফোল্ডারে এক জিনিস থাকে না। খোয়ারিজমির ফোল্ডারে হয়তো একটা ইসিজি রিপোর্ট আছে, সিনার ফোল্ডারে সেটা নেই কিন্তু আছে ডায়াবেটিসের চার্ট। ফাতিমাকে আগে থেকে ঠিক করে রাখতে হয় না যে "প্রতিটা ফোল্ডারে ঠিক এই এই কাগজই থাকবে" — যার যা লাগে, তার ফোল্ডারে সেটাই ঢোকে। নতুন কোনো টেস্ট এলে সেটা এমনি ফোল্ডারে যোগ হয়ে যায়, বাকিদের ফোল্ডার ঘাঁটতে হয় না।
