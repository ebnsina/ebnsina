...
রেজিস্ট্রেশন অফিসের কাউন্টারে বসেন ফাতিমা — কড়া ধাঁচের ফর্ম-চেকিং ক্লার্ক। যে ফর্মই তাঁর টেবিলে আসে, ফাইলে যাওয়ার আগে তিনি নিয়মে না মিললে সেটা ফেরত দেন। সিনা একটা ফর্ম জমা দিলেন যেখানে বাধ্যতামূলক "নাম" ঘরটা ফাঁকা — ফাতিমা সঙ্গে সঙ্গে ফিরিয়ে দিলেন, "নাম ছাড়া ফর্ম নেব না।" পরের জন এমন একটা ID নম্বর লিখলেন যেটা আগেই একজনের নামে রেজিস্টার করা — সেটাও বাউন্স, "এই নম্বর তো আগেই আছে।"

এরপর এক ফর্মে বয়স লেখা মাইনাস পাঁচ — ফাতিমা হেসে সেটা ছুঁড়ে ফেললেন, "বয়স তো positive হতে হবে।" আর খোয়ারিজমি এমন এক অভিভাবক-অ্যাকাউন্ট নম্বর রেফার করলেন যেটার কোনো অস্তিত্বই নেই ফাইলে — "যে অ্যাকাউন্ট নেই, তার রেফারেন্স নেব কী করে?" বলে সেটাও প্রত্যাখ্যাত। কাউন্টারেই যাচাই হয় বলে একটাও ভুল ফর্ম কখনো পেছনের ফাইল পর্যন্ত পৌঁছায় না।
