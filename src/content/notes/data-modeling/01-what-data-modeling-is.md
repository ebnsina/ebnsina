...
স্থপতি সিনা একটা বাড়ি বানানোর দায়িত্ব পেলেন। এক ইট গাঁথার আগেই তিনি টেবিলে ট্রেসিং পেপার বিছিয়ে blueprint আঁকতে বসলেন। প্রথমে ঠিক করলেন কোন কোন ঘর থাকবে — রান্নাঘর, খাবার ঘর, শোবার ঘর, দুটো বাথরুম। তারপর প্রতিটা ঘরের কাজ ঠিক করলেন: রান্নাঘরে চুলা আর সিঙ্ক, শোবার ঘরে আলমারি আর জানালা। শেষে ঠিক করলেন ঘরগুলো একে অন্যের সাথে কীভাবে জুড়বে — রান্নাঘর রাখলেন খাবার ঘরের গা ঘেঁষে যাতে খাবার গরম গরম টেবিলে আসে, আর দুটো বাথরুমকে একই দেয়াল বরাবর রাখলেন যাতে plumbing এক লাইনেই যায়।

পাশের প্লটে খোয়ারিজমি blueprint ছাড়াই মিস্ত্রি লাগিয়ে দিলেন — "কাজ করতে করতে ঠিক হয়ে যাবে।" মাস তিনেক পর দেখা গেল বাথরুম রান্নাঘরের উল্টো কোণে, pipe টানতে গিয়ে দেয়াল ভাঙতে হচ্ছে, আর সিঁড়িটা এমন জায়গায় বসেছে যে খাবার ঘরে ঢোকাই কঠিন। এখন দেয়াল ভেঙে আবার গাঁথা — সময়, টাকা, দুটোই দ্বিগুণ।

এটাই data modeling। সিনার "কোন কোন ঘর থাকবে" হলো আপনার entity/table ঠিক করা (users, listings, orders); প্রতিটা ঘরে কী থাকবে হলো attribute বাছা (email, title, price, status); ঘরগুলো কীভাবে জুড়বে হলো relationship বসানো (foreign key দিয়ে order-কে listing-এর সাথে, listing-কে seller-এর সাথে)। আর blueprint আগে আঁকার পুরো মানেটাই হলো CREATE TABLE টাইপ করার আগে schema ভেবে নেওয়া — কারণ বাস্তবে খোয়ারিজমির দেয়াল ভাঙার মতোই, লক্ষ লক্ষ row জমে যাওয়ার পর একটা column rename বা relationship বদলানো মানে গোটা app জুড়ে সপ্তাহব্যাপী migration আর refactor।
