...
খোয়ারিজমির একটা রিসার্চ অফিস, যেখানে প্রতিটা কর্মচারীর নিজের একটা ID badge আছে। সিনার badge দিয়ে সে তার নিজের ডেস্ক আর কমন এরিয়ায় ঢুকতে পারে, কিন্তু সে অন্য কারও ফাইল ক্যাবিনেট খুলতে পারে না — তার badge-এ শুধু ততটুকুই অনুমতি দেওয়া আছে যতটুকু তার কাজের জন্য দরকার। আবার badge-গুলো নানা team-এ ভাগ করা: "লাইব্রেরি team"-এর badge থাকলে আর্কাইভ রুমে ঢোকা যায়, "ল্যাব team"-এর badge থাকলে যন্ত্রপাতির ঘরে। ফাতিমা দুই team-এই আছেন, তাই তার badge দুই রুমেই কাজ করে — team-এ থাকার সুবাদে শেয়ার করা access পাওয়া।

এখন সিনার হঠাৎ সার্ভার রুম রিবুট করার মতো একটা restricted কাজ দরকার। সে কিন্তু সারাদিন ম্যানেজারের all-powerful master key পকেটে নিয়ে ঘুরে বেড়ায় না — সেটা হলে একটা ভুলেই সে যেকোনো রুমের যেকোনো জিনিস নষ্ট করে ফেলতে পারত। বদলে সে একটা নির্দিষ্ট procedure মানে: ওই একটা কাজের জন্য master key চায়, নিজের পরিচয় দেয়, রেজিস্টারে "কে, কখন, কোন কাজে" লেখা হয়ে যায়, কাজ শেষ হলেই key ফেরত। ক্ষমতাটা এসেছিল সাময়িকভাবে, ঠিক ওই এক কাজের জন্য।
