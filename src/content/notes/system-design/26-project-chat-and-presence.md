...
৫০ লাখ socket মানে প্রায় ৫০০টা gateway node, প্রতিটায় ১০ হাজার connection। সিনা যখন connect করেন, load balancer তাঁকে যেকোনো একটা node-এ ফেলে দেয় — কোনটা, সেটা কেউ আগে থেকে ঠিক করে না। ফলে "সিনাকে মেসেজ পাঠাও" মানে প্রথমে জানতে হবে তিনি কোন node-এ আছেন।
...
খোয়ারিজমি আর সিনা একই conversation-এ দ্রুত টাইপ করছেন। দুজনের মেসেজ দুটো ভিন্ন API সার্ভারে পৌঁছাল, আর সেই দুই সার্ভারের ঘড়ি NTP দিয়ে sync করা হলেও বাস্তবে ৫ থেকে ৫০ মিলিসেকেন্ড পর্যন্ত আলাদা থাকতে পারে। ফলে যে মেসেজটা আসলে পরে লেখা হয়েছে, তার timestamp আগের হয়ে যেতে পারে। ক্লায়েন্ট timestamp দিয়ে sort করলে কথোপকথনের যুক্তিই উল্টে যায় — উত্তরটা প্রশ্নের আগে দেখা যায়।
...
**Read cursor** এই পুরো টেবিলটাকে এক লাইনে নামিয়ে আনে: প্রতি (conversation, user)-এ শুধু দুটো সংখ্যা — `delivered_up_to` আর `read_up_to`। সিনা ১২ নম্বর পর্যন্ত পড়েছেন মানে ১ থেকে ১২ সব পড়া। কোনো মেসেজ পড়া কিনা জানতে হলে শুধু তুলনা: তার seq কি cursor-এর সমান বা কম?
...
ধরুন সিনার contact list-এ ২০০ জন আছে, আর সেই ২০০ জনের প্রত্যেকের list-এও সিনা আছেন। সিনা online হলে ২০০টা notification যায়। এখন ৩০ লাখ ইউজার একসাথে online — সকাল ৯টায় শহর জেগে ওঠার সময় ঠিক এটাই ঘটে। ৩০ লাখ গুণ ২০০ = ৬০ কোটি notification, কয়েক মিনিটের মধ্যে। মেসেজের চেয়ে এটা কয়েকশো গুণ বেশি ট্রাফিক, অথচ ফিচারটা একটা সবুজ ডট।
...
**Coalescing/debounce** — status পরিবর্তন সাথে সাথে পাঠানো হয় না। Presence service প্রতি ৫ সেকেন্ডে একবার জমা হওয়া সব পরিবর্তন একসাথে ব্যাচ করে পাঠায়। সিনা যদি টানেলে ঢুকে ১০ সেকেন্ডে তিনবার offline-online করেন, subscriber-রা তিনটার বদলে একটা আপডেট পান। ব্যস্ত সময়ে এটা ৭০% পর্যন্ত event কমায়।
...
Presence-এর জন্য কড়া consistency দাবি করবেন না। "সিনা online" তথ্যটা ৩০ সেকেন্ড পুরনো হলে ব্যবহারকারীর কিছুই যায় আসে না — কিন্তু সেটা রিয়েল-টাইম করতে গেলে ট্রাফিক দশগুণ বাড়ে এবং একটা সম্পূর্ণ নতুন ব্যর্থতার উৎস তৈরি হয়। এটাই চ্যাপ্টার ১০-এর eventual consistency-র সবচেয়ে খাঁটি ব্যবহার।
...
সমস্যা হলো এই দুটো পথ race করে। সিনা মেসেজ পাওয়ার ঠিক ২০ মিলিসেকেন্ড আগে ফোন লক করলেন — registry বলল online, frame পাঠানো হলো, কিন্তু socket ততক্ষণে মরে গেছে। মেসেজ কোথাও পৌঁছাল না, push-ও গেল না।
