...
- **Intention preservation** — আল-বিরুনি যদি "নূর" শব্দটা বাক্যের মাঝখানে বসাতে চেয়ে থাকেন, শব্দটা যেন বাক্যের মাঝখানেই থাকে, অক্ষরগুলো ছিটকে না যায়।
- **Causality** — ইবনে সিনা যদি আগে একটা প্যারাগ্রাফ লিখে তারপর সেটা মুছে দেন, কোনো replica যেন "মোছা" অপারেশনটা "লেখা"র আগে প্রয়োগ না করে।
...
**দুই: coalesce করুন।** ইবনে সিনা টাইপ করলে সেকেন্ডে ৩০ বার cursor সরে। প্রতিবার broadcast করলে ৫০ জনের room-এ সেকেন্ডে ১৫০০ মেসেজ। বদলে ৫০-১০০ms-এর window-এ শেষ অবস্থাটাই পাঠান — cursor-এর মধ্যবর্তী অবস্থানগুলো কারও দরকার নেই। এটাই চ্যাপ্টার ৯-এ দেখা batching-এর সরাসরি প্রয়োগ।
...
ইবনে সিনা প্লেনে বসে ২০ মিনিট ধরে লিখেছেন, নেটওয়ার্ক নেই। তার ব্রাউজারে ৩০০টা op জমেছে, সবগুলো তার local replica-তে প্রয়োগ হয়ে গেছে — সে যা দেখছে সেটা তার কাছে সম্পূর্ণ বৈধ ডকুমেন্ট। এদিকে আল-বিরুনি একই সময়ে ৫০০টা op করেছেন।
